	...
	return (
		<Aside>
			...
			<AsideBody>
				<Nav>
					{/* NAVCOLLAPSE EMPRESA */}
					<AuthorityCheckNav authority={Pages.empresa.authority} userAuthority={listaGrupos?.grupos}>
						<NavCollapse text={Pages.empresa.text} icon={Pages.empresa.icon} to={Pages.empresa.to}>
							<AuthorityCheckNav authority={Pages.empresa.subPages.listaEmpresas.authority} userAuthority={listaGrupos?.grupos}>
								<NavItem text={Pages.empresa.subPages.listaEmpresas.text} to={Pages.empresa.subPages.listaEmpresas.to} icon={Pages.empresa.subPages.listaEmpresas.icon} id={Pages.empresa.subPages.listaEmpresas.id}></NavItem>
							</AuthorityCheckNav>
							<AuthorityCheckNav authority={Pages.empresa.subPages.listaUsuariosEmpresa.authority} userAuthority={listaGrupos?.grupos}>
								<NavItem text={Pages.empresa.subPages.listaUsuariosEmpresa.text} to={Pages.empresa.subPages.listaUsuariosEmpresa.to} icon={Pages.empresa.subPages.listaUsuariosEmpresa.icon} id={Pages.empresa.subPages.listaUsuariosEmpresa.id}></NavItem>
							</AuthorityCheckNav>
							...
							<AuthorityCheckNav authority={Pages.empresa.subPages.detalleCliente.authority} userAuthority={listaGrupos?.grupos}>
								<NavCollapse text={Pages.empresa.subPages.detalleCliente.text} icon={Pages.empresa.subPages.detalleCliente.icon} to={Pages.empresa.subPages.detalleCliente.to}>
									<CrearClienteEnMenu />
									{listaMisClientes.length > 0 ? (listaMisClientes.map((cli, index) => (
										<NavItem text={cli.info_cliente.nombre} to={`/empresa/detalle-cliente/${cli.id}`} icon={Pages.empresa.subPages.detalleCliente.icon} id={index.toString()} key={index}></NavItem>
									))) : (
					...
					{/* cotizacion */}
					<AuthorityCheckNav authority={Pages.cotizacion.authority} userAuthority={listaGrupos?.grupos}>
						<NavCollapse text={Pages.cotizacion.text} icon={Pages.cotizacion.icon} to={Pages.cotizacion.to}>
							...
							<AuthorityCheckNav authority={Pages.cotizacion.subPages.listaCotizacionesEmpresa.authority} userAuthority={listaGrupos?.grupos}>
								<NavItem text={Pages.cotizacion.subPages.listaCotizacionesEmpresa.text} to={Pages.cotizacion.subPages.listaCotizacionesEmpresa.to} icon={Pages.cotizacion.subPages.listaCotizacionesEmpresa.icon} id={Pages.cotizacion.subPages.listaCotizacionesEmpresa.id}></NavItem>
							</AuthorityCheckNav>
						</NavCollapse>
					</AuthorityCheckNav>

					{/* navcollapse compras */}
					<AuthorityCheckNav authority={Pages.compras.authority} userAuthority={listaGrupos?.grupos}>
						<NavCollapse text={Pages.compras.text} icon={Pages.compras.icon} to={Pages.compras.to}>
							<AuthorityCheckNav authority={Pages.compras.subPages.listaOrdenesCompra.authority} userAuthority={listaGrupos?.grupos}>
								<NavItem text={Pages.compras.subPages.listaOrdenesCompra.text} to={Pages.compras.subPages.listaOrdenesCompra.to} icon={Pages.compras.subPages.listaOrdenesCompra.icon} id={Pages.compras.subPages.listaOrdenesCompra.id}></NavItem>
							</AuthorityCheckNav>
							<AuthorityCheckNav authority={Pages.compras.subPages.listaMisOrdenesDeCompra.authority} userAuthority={listaGrupos?.grupos}>
								<NavItem text={Pages.compras.subPages.listaMisOrdenesDeCompra.text} to={Pages.compras.subPages.listaMisOrdenesDeCompra.to} icon={Pages.compras.subPages.listaMisOrdenesDeCompra.icon} id={Pages.compras.subPages.listaMisOrdenesDeCompra.id}></NavItem>
							</AuthorityCheckNav>
							<AuthorityCheckNav authority={Pages.compras.subPages.listaCompra.authority} userAuthority={listaGrupos?.grupos}>
								<NavItem text={Pages.compras.subPages.listaCompra.text} to={Pages.compras.subPages.listaCompra.to} icon={Pages.compras.subPages.listaCompra.icon} id={Pages.compras.subPages.listaCompra.id}></NavItem>
							</AuthorityCheckNav>
						</NavCollapse>
					</AuthorityCheckNav>

					{/* bodegas */}
					<AuthorityCheckNav authority={Pages.bodega.authority} userAuthority={listaGrupos?.grupos}>
						<NavCollapse text={Pages.bodega.text} icon={Pages.bodega.icon} to={Pages.bodega.to}>
							<AuthorityCheckNav authority={Pages.bodega.subPages.listaBodegas.authority} userAuthority={listaGrupos?.grupos}>
								<NavItem text={Pages.bodega.subPages.listaBodegas.text} to={Pages.bodega.subPages.listaBodegas.to} icon={Pages.bodega.subPages.listaBodegas.icon} id={Pages.bodega.subPages.listaBodegas.id}></NavItem>
							</AuthorityCheckNav>
							<AuthorityCheckNav authority={Pages.bodega.subPages.listaGuiaSalida.authority} userAuthority={listaGrupos?.grupos}>
								<NavItem text={Pages.bodega.subPages.listaGuiaSalida.text} to={Pages.bodega.subPages.listaGuiaSalida.to} icon={Pages.bodega.subPages.listaGuiaSalida.icon} id={Pages.bodega.subPages.listaGuiaSalida.id}></NavItem>
							</AuthorityCheckNav>
							<AuthorityCheckNav authority={Pages.bodega.subPages.listaTomaInventario.authority} userAuthority={listaGrupos?.grupos}>
								<NavItem text={Pages.bodega.subPages.listaTomaInventario.text} to={Pages.bodega.subPages.listaTomaInventario.to} icon={Pages.bodega.subPages.listaTomaInventario.icon} id={Pages.bodega.subPages.listaTomaInventario.id}></NavItem>
							</AuthorityCheckNav>
							{listaBodegas.length > 0 && (
								<NavCollapse text="Bodegas" icon='HeroDocument' to="/">
									{listaBodegas.map((bodega, index) => (
										<NavItem key={index} text={bodega.nombre} icon="HeroDocument" to={`/bodega/detalle-bodega/${bodega.id}`} id={bodega.id.toString()}></NavItem>
									))}
								</NavCollapse>
							)}
						</NavCollapse>
					...
					{/* orden trabajo */}
					<AuthorityCheckNav authority={Pages.ordenTrabajo.authority} userAuthority={listaGrupos?.grupos}>
						<NavCollapse text={Pages.ordenTrabajo.text} icon={Pages.ordenTrabajo.icon} to={Pages.ordenTrabajo.to}>
							<AuthorityCheckNav authority={Pages.ordenTrabajo.subPages.listaOrdenesTrabajo.authority} userAuthority={listaGrupos?.grupos}>
								<NavItem text={Pages.ordenTrabajo.subPages.listaOrdenesTrabajo.text} to={Pages.ordenTrabajo.subPages.listaOrdenesTrabajo.to} icon={Pages.ordenTrabajo.subPages.listaOrdenesTrabajo.icon} id={Pages.ordenTrabajo.subPages.listaOrdenesTrabajo.id}></NavItem>
							</AuthorityCheckNav>

							{/* navcollapse visitas */}
							<AuthorityCheckNav authority={Pages.ordenTrabajo.subPages.listaVisitasSoporte.authority} userAuthority={listaGrupos?.grupos}>
								<NavItem text={Pages.ordenTrabajo.subPages.listaVisitasSoporte.text} to={Pages.ordenTrabajo.subPages.listaVisitasSoporte.to} icon={Pages.ordenTrabajo.subPages.listaVisitasSoporte.icon} id={Pages.ordenTrabajo.subPages.listaVisitasSoporte.id}></NavItem>
							</AuthorityCheckNav>
						</NavCollapse>
					</AuthorityCheckNav>

					{/* Recursos */}
					<AuthorityCheckNav authority={Pages.recursos.authority} userAuthority={listaGrupos?.grupos}>
						<NavCollapse text={Pages.recursos.text} icon={Pages.recursos.icon} to={Pages.recursos.to}>
							{/* <AuthorityCheckNav authority={Pages.recursos.subPages.listaEquiposDeMisClientes.authority} userAuthority={listaGrupos?.grupos}>
								<NavItem text={Pages.recursos.subPages.listaEquiposDeMisClientes.text} to={Pages.recursos.subPages.listaEquiposDeMisClientes.to} icon={Pages.recursos.subPages.listaEquiposDeMisClientes.icon} id={Pages.registros.subPages.listaCategorias.id}></NavItem>
							</AuthorityCheckNav> */}
							<AuthorityCheckNav authority={Pages.recursos.subPages.listaSoftware.authority} userAuthority={listaGrupos?.grupos}>
								<NavItem text={Pages.recursos.subPages.listaSoftware.text} to={Pages.recursos.subPages.listaSoftware.to} icon={Pages.recursos.subPages.listaSoftware.icon} id={Pages.registros.subPages.listaCategorias.id}></NavItem>
							</AuthorityCheckNav>
						</NavCollapse>
					</AuthorityCheckNav>

					{/* Registros */}
					<AuthorityCheckNav authority={Pages.registros.authority} userAuthority={listaGrupos?.grupos}>
						<NavCollapse text={Pages.registros.text} icon={Pages.registros.icon} to={Pages.registros.to}>
							<AuthorityCheckNav authority={Pages.registros.subPages.listaCategorias.authority} userAuthority={listaGrupos?.grupos}>
								<NavItem text={Pages.registros.subPages.listaCategorias.text} to={Pages.registros.subPages.listaCategorias.to} icon={Pages.registros.subPages.listaCategorias.icon} id={Pages.registros.subPages.listaCategorias.id}></NavItem>
							</AuthorityCheckNav>
							<AuthorityCheckNav authority={Pages.registros.subPages.listaFabricantes.authority} userAuthority={listaGrupos?.grupos}>
								<NavItem text={Pages.registros.subPages.listaFabricantes.text} to={Pages.registros.subPages.listaFabricantes.to} icon={Pages.registros.subPages.listaFabricantes.icon} id={Pages.registros.subPages.listaFabricantes.id}></NavItem>
							</AuthorityCheckNav>
							<AuthorityCheckNav authority={Pages.registros.subPages.listaProveedoresEmpresa.authority} userAuthority={listaGrupos?.grupos}>
								<NavItem text={Pages.registros.subPages.listaProveedoresEmpresa.text} to={Pages.registros.subPages.listaProveedoresEmpresa.to} icon={Pages.registros.subPages.listaProveedoresEmpresa.icon} id={Pages.registros.subPages.listaProveedoresEmpresa.id}></NavItem>
							</AuthorityCheckNav>
							<AuthorityCheckNav authority={Pages.registros.subPages.listaItemsEmpresa.authority} userAuthority={listaGrupos?.grupos}>
								<NavItem text={Pages.registros.subPages.listaItemsEmpresa.text} to={Pages.registros.subPages.listaItemsEmpresa.to} icon={Pages.registros.subPages.listaItemsEmpresa.icon} id={Pages.registros.subPages.listaItemsEmpresa.id}></NavItem>
							</AuthorityCheckNav>
							<AuthorityCheckNav authority={Pages.registros.subPages.listaUsuarios.authority} userAuthority={listaGrupos?.grupos}>
								<NavItem text={Pages.registros.subPages.listaUsuarios.text} to={Pages.registros.subPages.listaUsuarios.to} icon={Pages.registros.subPages.listaUsuarios.icon} id={Pages.registros.subPages.listaUsuarios.id}></NavItem>
							</AuthorityCheckNav>
						</NavCollapse>
					</AuthorityCheckNav>

					{/* navcollapse vacaciones */}
					<AuthorityCheckNav authority={Pages.vacaciones.authority} userAuthority={listaGrupos?.grupos}>
						<NavCollapse text={Pages.vacaciones.text} icon={Pages.vacaciones.icon} to={Pages.vacaciones.to}>
							<AuthorityCheckNav authority={Pages.vacaciones.subPages.listaMisSolicitudesVacaciones.authority} userAuthority={listaGrupos?.grupos}>
								<NavItem text={Pages.vacaciones.subPages.listaMisSolicitudesVacaciones.text} to={Pages.vacaciones.subPages.listaMisSolicitudesVacaciones.to} icon={Pages.vacaciones.subPages.listaMisSolicitudesVacaciones.icon} id={Pages.vacaciones.subPages.listaMisSolicitudesVacaciones.id}></NavItem>
							</AuthorityCheckNav>
							<AuthorityCheckNav authority={Pages.vacaciones.subPages.pedirVacaciones.authority} userAuthority={listaGrupos?.grupos}>
								<NavItem text={Pages.vacaciones.subPages.pedirVacaciones.text} to={Pages.vacaciones.subPages.pedirVacaciones.to} icon={Pages.vacaciones.subPages.pedirVacaciones.icon} id={Pages.vacaciones.subPages.pedirVacaciones.id}></NavItem>
							</AuthorityCheckNav>
							<AuthorityCheckNav authority={Pages.vacaciones.subPages.pedirVacacionesUsuario.authority} userAuthority={listaGrupos?.grupos}>
								<NavItem text={Pages.vacaciones.subPages.pedirVacacionesUsuario.text} to={Pages.vacaciones.subPages.pedirVacacionesUsuario.to} icon={Pages.vacaciones.subPages.pedirVacacionesUsuario.icon} id={Pages.vacaciones.subPages.pedirVacacionesUsuario.id}></NavItem>
							</AuthorityCheckNav>
                                                        <AuthorityCheckNav authority={Pages.vacaciones.subPages.listaSolicitudesVacaciones.authority} userAuthority={listaGrupos?.grupos}>
                                                                <NavItem text={Pages.vacaciones.subPages.listaSolicitudesVacaciones.text} to={Pages.vacaciones.subPages.listaSolicitudesVacaciones.to} icon={Pages.vacaciones.subPages.listaSolicitudesVacaciones.icon} id={Pages.vacaciones.subPages.listaSolicitudesVacaciones.id}></NavItem>
                                                        </AuthorityCheckNav>
                                                        <AuthorityCheckNav authority={Pages.vacaciones.subPages.dashboardVacaciones.authority} userAuthority={listaGrupos?.grupos}>
                                                                <NavItem text={Pages.vacaciones.subPages.dashboardVacaciones.text} to={Pages.vacaciones.subPages.dashboardVacaciones.to} icon={Pages.vacaciones.subPages.dashboardVacaciones.icon} id={Pages.vacaciones.subPages.dashboardVacaciones.id}></NavItem>
                                                        </AuthorityCheckNav>
                                                </NavCollapse>
                                        </AuthorityCheckNav>
