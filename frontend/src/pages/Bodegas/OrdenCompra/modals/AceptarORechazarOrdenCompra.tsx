...
function AceptarORechazarOrdenCompra({
    id_orden,
    onSuccess,
}: {
    ...
    const handleAceptarORechazar = async () => {
        ...
        if (result.isConfirmed) {
            ...
            try {
                ...
                toast.error(
                    typeof errorMessage === 'string' ? errorMessage : 'Error al aceptar la orden',
                    {
            ...
            try {
                ...
                toast.error(
                    typeof errorMessage === 'string' ? errorMessage : 'Error al rechazar la orden',
                    {
