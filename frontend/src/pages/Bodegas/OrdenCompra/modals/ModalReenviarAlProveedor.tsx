...
function ModalReenviarAlProveedor({id_empresa, id_proveedor, id_orden} : {id_empresa: string | number | null | undefined, id_proveedor: string | number | undefined | null, id_orden: string | number | undefined}) {
