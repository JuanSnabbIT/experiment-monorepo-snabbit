...
function EditarItemEnOrdenCompra({
    item,
    id_orden,
}: {
    item: IItemEnOrdenCompra;
        ...
        onSubmit: async (values) => {
            ...
            try {
                const response = await ApiService.fetchData({
                    url: `/api/ordenes-compra/${id_orden}/items-en-orden-compra/${item.id}/`,
                    method: 'patch',
                ...
                toast.error(
                    typeof errorMessage === 'string' ? errorMessage : 'Error al guardar el item',
                    {
                        autoClose: 1000,
