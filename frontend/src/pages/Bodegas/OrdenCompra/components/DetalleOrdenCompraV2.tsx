						...
						<CardBody>
							<div className='grid grid-cols-2 items-center gap-4 md:grid-cols-3 lg:grid-cols-5'>
								...
								<div className='w-full'>
									...
									<div className='ml-4'>{detalleOrdenCompra?.tipo_moneda_label}</div>
								</div>
									...
									<div className='mt-4 flex min-w-[600px] flex-wrap justify-end gap-6 text-right'>
										<div>
											...
											<div className='font-semibold'>
												${formatPrice(valorNeto)} {detalleOrdenCompra?.tipo_moneda_label}
											</div>
										</div>
										<div>
											<Badge>IVA:</Badge>
											<div className='font-semibold'>
												${formatPrice(valorIva)} {detalleOrdenCompra?.tipo_moneda_label}
											</div>
										</div>
										<div>
											<Badge>Total:</Badge>
											<div className='font-semibold'>
												${formatPrice(valorTotal)} {detalleOrdenCompra?.tipo_moneda_label}
											</div>
										</div>
									</div>
								</div>
