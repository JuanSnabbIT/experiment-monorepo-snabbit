...
function DetalleCompra() {
    ...
    const { id } = useParams();
    const {
        detalleCompra: detalleCompraState,
        listaBodegas,
        listaItemsCompra,
    ...
    const itemsInvalidos = listaItemsCompra.some((item) => item.cantidad <= 0 || item.precio <= 0);
                        ...
                        <Card>
                            ...
                            <CardBody>
                                {detalleCompra?.orden_trabajo ? (
                                    <div className='ml-4'>
                                        Esta compra esta asociada a una OT. Los items se ingresaran
                                        al sistema cuando se complete la OT y se definan los
                                        sobrantes.
                                    </div>
                                ) : (
