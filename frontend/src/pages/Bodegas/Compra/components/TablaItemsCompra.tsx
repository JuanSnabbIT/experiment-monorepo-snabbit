...
export function ItemEnTabla({
	...
	return (
		<>
			<div
				className='grid grid-cols-4 items-center gap-4 rounded-xl border border-blue-500 py-2'>
				<div>
...
function TablaItemsCompra() {
	...
	const detalleCompraValida =
		detalleCompra && detalleCompra.id.toString() === (id ?? '');
