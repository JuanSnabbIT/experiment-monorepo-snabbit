...
const ModalDetallItem = ({valuess, id_cotizacion, id_item}: { valuess: IItemCotizacion; id_cotizacion: number | string | any; id_item: number }) => {
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        {isEditing ? (
                            <>
                                ...
                                <div>
                                    ...
                                    <Validation
                                        ...
                                        invalidFeedback={typeof formikDetalle.errors.cantidad === 'string' ? formikDetalle.errors.cantidad : undefined}
                                    >
                                        <Input
                                            name="cantidad"
                                            id="cantidad"
                                ...
                                <div>
                                    ...
                                    <Validation
                                        ...
                                        invalidFeedback={typeof formikDetalle.errors.precio_unitario === 'string' ? formikDetalle.errors.precio_unitario : undefined}
                                    >
                                        <Input
                            ...
                            <>
                                ...
                                <div className="col-span-full">
                                    <Badge>Descripcion</Badge>
                                    <div className="ml-4">{valuess.descripcion || "Sin Descripción"}</div>
                                </div>
                                <div className="w-full">
