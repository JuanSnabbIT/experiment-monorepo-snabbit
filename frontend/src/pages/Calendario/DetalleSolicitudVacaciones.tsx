...
import { detalleSolicitudVacacionesThunk, listaDiasCalendarioThunk } from "@/store/slices/calendario/calendarioSlice"
...
function DetalleSolicitudVacaciones() {
    ...
    const { detalleSolicitudVacaciones, listaDiasCalendario } = useAppSelector((state) => state.calendario)
                                ...
                                <CardBody>
                                    <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
                                        ...
                                        <div className="w-full">
                                            ...
                                            <div className="ml-4">{detalleSolicitudVacaciones ? `${calcularDiasHabilesConCalendario(new Date(detalleSolicitudVacaciones.fecha_inicio), new Date(detalleSolicitudVacaciones.fecha_fin), listaDiasCalendario)} dias ` : "Sin Usuario"}</div>
                                        </div>
                                    </div>
                                </CardBody>
                            </Card>
