        ...
        onSubmit: async (values) => {
            try {
                const response = await ApiService.fetchData({
                    url: `/api/empresas/${personalizacionUsuario?.empresa}/proveedores-empresa/`,
                    method: 'post',
        ...
        if (formik.values.region) {
            setOptProvincias(
                listaProvincias
                    .filter(
                        (provincia) =>
                            provincia.provincia_region.toString() === formik.values.region,
                    )
                    .map((prov) => {
                        return {
    ...
    useEffect(() => {
        if (formik.values.provincia) {
            setOptComunas(
                listaComunas
                    .filter(
                        (comuna) => comuna.comuna_provincia.toString() === formik.values.provincia,
                    )
                    .map((com) => {
                        ...
                        <div className='w-full'>
                            ...
                            <Validation
                                ...
                                <SelectReact
                                    ...
                                    options={optRegiones}
                                    onChange={(e) => {
                                        formik.setFieldValue('region', (e as TSelectOption).value);
                                    }}
                                    value={{
                                        value: formik.values.region,
                                        label:
                                            optRegiones.find(
                                                (region) => region.value === formik.values.region,
                                            )?.label || '',
                                    }}
                                />
                            </Validation>
                                ...
                                <SelectReact
                                    ...
                                    value={{
                                        ...
                                        label:
                                            optProvincias.find(
                                                (provincia) =>
                                                    provincia.value === formik.values.provincia,
                                            )?.label || '',
                                    }}
                                />
                            </Validation>
                        ...
                        <div className='w-full'>
                            ...
                            <Validation
                                ...
                                <SelectReact
                                    ...
                                    options={optComunas}
                                    onChange={(e) => {
                                        formik.setFieldValue('comuna', (e as TSelectOption).value);
                                    }}
                                    value={{
                                        value: formik.values.comuna,
                                        label:
                                            optComunas.find(
                                                (comuna) => comuna.value === formik.values.comuna,
                                            )?.label || '',
                                    }}
                                />
                            </Validation>
