        ...
        onSubmit: async (values) => {
            try {
                const response = await ApiService.fetchData({
                    url: `/api/movimientos-stock/crear-inicial/`,
                    method: 'post',
                ...
                toast.error(mensajesError || 'Error al crear el movimiento stock inicial', {
                    toastId: 'Error al crear el movimiento stock inicial',
                });
            }
        },
    });
                            ...
                            <Validation
                                ...
                                <SelectReact
                                    ...
                                    value={{
                                        ...
                                        label:
                                            listaBodegasPorEmpresa.find(
                                                (bode) =>
                                                    bode.id.toString() === formik.values.bodega,
                                            )?.nombre || '',
                                    }}
                                />
                            </Validation>
