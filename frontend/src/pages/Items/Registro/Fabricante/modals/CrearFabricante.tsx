...
const CrearFabricante = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            try {
                const response = await ApiService.fetchData({ url: `/api/fabricantes/`, method: 'post', data: values });
                if (response) {
                ...
                toast.error(error.response.data || 'Error creando fabricante', {toastId: 'Error creando fabricante'})
            }
        }
    })
