...
const crearIdTemporal = () => `tmp-${Date.now()}-${Math.random().toString(36).slice(2, 8)}`;
...
const formatosPermitidos: ScannerFormats = [
    'ean_13',
    'code_128',
    'code_93',
    'code_39',
...
function CrearCompraRapidaEnOT() {
    ...
    const itemFormik = useFormik<CompraItemDraft>({
        ...
        onSubmit: (values) => {
            ...
            if (values.creando) {
                ...
                if (
                    nombreNormalizado &&
                    items.some((item) => item.nombre.trim().toLowerCase() === nombreNormalizado)
                ) {
                    toast.error('El item ya esta agregado.', { toastId: 'item-duplicado' });
                    return;
                }
    ...
    const opcionesItems = useMemo(
        () =>
            listaItemsEmpresa
                .filter(
                    (item) =>
                        !items.some((seleccionado) => seleccionado.item === item.id.toString()),
                )
                .map((item) => ({
    ...
    const fabricanteSeleccionado = itemFormik.values.fabricante
        ? {
              ...
              label:
                  listaFabricante.find((fab) => fab.id.toString() === itemFormik.values.fabricante)
                      ?.nombre || '',
          }
        : null;
    ...
    const categoriaSeleccionada = itemFormik.values.categoria
        ? {
              ...
              label:
                  listaCategorias.find((cat) => cat.id.toString() === itemFormik.values.categoria)
                      ?.nombre || '',
          }
        : null;
                                        ...
                                        <div className='grid grid-cols-1 gap-3 md:grid-cols-12'>
                                            <div className='md:col-span-6'>
                                                ...
                                                <Validation
                                                    ...
                                                    isTouched={
                                                        itemFormik.touched.item ||
                                                        itemFormik.touched.nombre
                                                    }
                                                    invalidFeedback={
                                                        itemFormik.errors.item ||
                                                        itemFormik.errors.nombre
                                                    }>
                                                    <SelectReact
                                                        name='item'
                                                        ...
                                                        value={
                                                            itemFormik.values.creando
                                                                ? {
                                                                      value: itemFormik.values
                                                                          .nombre,
                                                                      label: itemFormik.values
                                                                          .nombre,
                                                                  }
                                            ...
                                            <>
                                                <div className='grid grid-cols-1 gap-3 md:grid-cols-12'>
                                                    <div className='md:col-span-6'>
                                                        ...
                                                        <Validation
                                                            isValid={itemFormik.isValid}
                                                            isTouched={
                                                                itemFormik.touched.fabricante
                                                            }
                                                            invalidFeedback={
                                                                itemFormik.errors.fabricante
                                                            }>
                                                            <SelectReact
                                                                name='fabricante'
                                                ...
                                                <div className='grid grid-cols-1 gap-3 md:grid-cols-12'>
                                                    <div className='md:col-span-6'>
                                                        ...
                                                        <Validation
                                                            isValid={itemFormik.isValid}
                                                            isTouched={
                                                                itemFormik.touched.descripcion_corta
                                                            }
                                                            invalidFeedback={
                                                    ...
                                                    <div className='md:col-span-6'>
                                                        ...
                                                        <Validation
                                                            isValid={itemFormik.isValid}
                                                            isTouched={
                                                                itemFormik.touched.comentarios
                                                            }
                                                            invalidFeedback={
                                                                itemFormik.errors.comentarios
                                                            }>
                                                            <Textarea
                                                                name='comentarios'
                                                                onChange={itemFormik.handleChange}
                                                ...
                                                <div className='md:w-1/2'>
                                                    ...
                                                    <Validation
                                                        ...
                                                        invalidFeedback={
                                                            itemFormik.errors.codigo_barras
                                                        }>
                                                        <Input
                                                            name='codigo_barras'
                                                            onChange={itemFormik.handleChange}
