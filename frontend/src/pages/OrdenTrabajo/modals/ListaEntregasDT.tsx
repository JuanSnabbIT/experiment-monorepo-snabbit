...
function ListaEntregasDT({isOpen, setIsOpen, detalleSeleccionado, setDetalleSeleccionado} : {isOpen: boolean, setIsOpen: Dispatch<SetStateAction<boolean>>, detalleSeleccionado: number | null, setDetalleSeleccionado: Dispatch<SetStateAction<number | null>>}) {
        ...
        columnHelper.display({
            ...
            cell: (info) => (
                <div className="flex justify-center gap-2">
                    {detalleDelDetalleTrabajo && detalleDelDetalleTrabajo.estado === "en_proceso" && info.row.original.estado_entrega === "por_entregar" && (
                        <>
    ...
    return (
        <>
                    ...
                    <div className="flex flex-col gap-4">
                        <div className="flex justify-end">
                            <AnimacionDeInputModoMovil globalFilter={globalFilter} setGlobalFilter={setGlobalFilter}>
                                {detalleDelDetalleTrabajo && (detalleDelDetalleTrabajo.estado === "pendiente" || detalleDelDetalleTrabajo.estado === "en_proceso") && (<CrearEntregaEquipoEnOT />)}
            ...
            <EditarEquipoVisita isOpen={isOpenEdiccion} setIsOpen={setIsOpenEdiccion} id_equipo={equipoSelected} />
        </>
    )
}
