                    ...
                    <div className='rounded-lg border border-blue-200 bg-blue-50 p-4'>
                        <div className='space-y-2 text-sm font-medium leading-relaxed text-blue-900'>
                            ...
                            <div className='border-t border-blue-200 pt-2'>
                                ...
                                , ¿Está de acuerdo con el resultado del trabajo realizado?
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <Validation
                            ...
                            <SelectReact
                                ...
                                value={
                                    usuariosOptions.find(
                                        (opt) => opt.value === formik.values.entregado_a,
                                    ) || null
                                }
                                onChange={(option: any) => {
                                    ...
                                    const receptorElement =
                                        document.getElementById('nombre-receptor');
                                    if (receptorElement) {
