...
import { listaAsistenciaUsuariosThunk, listaDetalleTrabajoOTThunk, listaUsuariosDelEquipoPorClienteThunk, useAppDispatch, useAppSelector } from "@/store"
...
function CrearAsistenciaUsuarioEnOT() {
    ...
    useEffect(() => {
        if (isOpen && detalleDelDetalleTrabajo) {
            dispatch(listaUsuariosDelEquipoPorClienteThunk({cliente_id: detalleOrdenTrabajo?.cliente}))
        }
