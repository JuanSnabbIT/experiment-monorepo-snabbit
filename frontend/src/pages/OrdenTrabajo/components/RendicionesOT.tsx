...
function RendicionesOT() {
    ...
    const { detalleOrdenTrabajo, listaDetalleGastoRendicionOT } = useAppSelector((state) => state.ordenTrabajo)
    ...
    const columns = [
        ...
        columnHelper.accessor("nombre_categoria", {
            cell: (info) => (
                <div>{info.getValue() ? info.getValue() : "Sin Categoria"}</div>
            ),
            header: "Categoria"
        }),
            ...
            cell: (info) => (
                <div>
                    <ModalEliminar
                        ...
                        peticionUrl={`/api/ordenes-trabajo/${detalleOrdenTrabajo?.id}/detalles-gastos/${info.row.original.id}/`}
                    ></ModalEliminar>
                </div>
            ),
            header: ""
