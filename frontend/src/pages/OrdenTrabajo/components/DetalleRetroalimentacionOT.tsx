...
function DetalleRetroalimentacionOT() {
    ...
    return (
        <PageWrapper
            ...
            name='Detalle Retroalimentación OT'
            title='Detalle Retroalimentación OT'>
            <Subheader>
                <SubheaderLeft>
                    <Button
                    ...
                    {detalleRetroalimentacionOT && (
                        <>
                                ...
                                <CardBody>
                                    <div className='grid grid-cols-3 gap-4'>
                                            ...
                                            <div className='ml-4'>
                                                {detalleRetroalimentacionOT.usuario_empresa ? (
                                                    ...
                                                    <>
                                                        <div>
                                                            {
                                                                detalleRetroalimentacionOT.usuario_externo
                                                            }
                                                        </div>
                                                        <div className='text-sm'>
                                                            Correo:{' '}
                                                            {
                                                                detalleRetroalimentacionOT.correo_usuario_externo
                                                            }
                                                        </div>
                                                    </>
                                                )}
                                        ...
                                        <div>
                                            ...
                                            <div className='ml-4'>
                                                {detalleRetroalimentacionOT.fecha_retroalimentacion
                                                    ? dayjs(
                                                          detalleRetroalimentacionOT.fecha_retroalimentacion,
                                                      )
                                                          .locale('es')
                                                          .format('DD/MM/YYYY')
                                                    : 'Sin Fecha de Retroalimentación'}
                                            </div>
                                        </div>
                                        <div>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <div className='flex flex-col gap-4'>
                                        {detalleRetroalimentacionOT.retroalimentacion_aplicada
                                            .length > 0 ? (
                                            detalleRetroalimentacionOT.retroalimentacion_aplicada.map(
                                                (retro, index) => (
                                                    <div
                                                        className='flex flex-col gap-4 rounded-xl border border-blue-500 p-4 text-center'
                                                        key={index}>
