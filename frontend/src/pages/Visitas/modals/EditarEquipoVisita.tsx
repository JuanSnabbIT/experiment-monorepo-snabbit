...
function EditarEquipoVisita({
    ...
    const { detalleEquipoEmpresa, listaSoftware, listaSoftwareEmpresa } = useAppSelector(
            ...
            try {
                const response = await ApiService.fetchData({
                    ...
                    data: JSON.stringify({
                        ...values,
                        fecha_compra:
                            values.fecha_compra.length > 0 ? values.fecha_compra : undefined,
                        fecha_caducidad_garantia:
                            values.fecha_caducidad_garantia.length > 0
                                ? values.fecha_caducidad_garantia
                                : undefined,
                    }),
                });
                if (response.data) {
                ...
                toast.error(error.response.data || 'Error al editar el equipo', {
                    toastId: 'Error al editar el equipo',
                });
            }
        },
    });
    ...
    const formikAlmacenamiento = useFormik({
        ...
        onSubmit: async (values) => {
            try {
                ...
                toast.error(error.response.data || 'Error al crear el almacenamiento', {
                    toastId: 'Error al crear el almacenamiento',
                });
            }
        },
    });
            ...
            <Modal size={'lg'} isOpen={isOpen} setIsOpen={setIsOpen}>
                <ModalHeader>
                    <Badge className='text-xl'>
                        Editar Equipo N°{detalleEquipoEmpresa?.numero_serie}
                    </Badge>
                </ModalHeader>
                <ModalBody>
                            ...
                            <Card className='border border-blue-500'>
                                ...
                                <CardBody className='grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5'>
                                    <div>
                                        ...
                                        <div className='ml-4'>
                                            {detalleEquipoEmpresa?.numero_serie}
                                        </div>
                                    </div>
                                    <div>
                                        <Badge>Marca*</Badge>
                                        {isEditting ? (
                                            ...
                                            <div className='ml-4'>
                                                {detalleEquipoEmpresa?.marca_label}
                                            </div>
                                        )}
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        {isEditting ? (
                                            ...
                                            <div className='ml-4'>
                                                {detalleEquipoEmpresa?.nombre_equipo ||
                                                    'Sin Nombre'}
                                            </div>
                                        )}
                                    </div>
                                    <div>
                                        ...
                                        {isEditting ? (
                                            <Validation
                                                ...
                                                invalidFeedback={
                                                    formik.errors.contraseña_administrador
                                                }>
                                                <Input
                                    ...
                                    <div>
                                        ...
                                        {isEditting ? (
                                            ...
                                            <div className='ml-4'>
                                                {detalleEquipoEmpresa?.ram_label}
                                            </div>
                                        )}
                                    </div>
                                    <div>
                                ...
                                <CardBody className='grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5'>
                                    <div>
                                        ...
                                        {isEditting ? (
                                            <Validation
                                                ...
                                                invalidFeedback={
                                                    formik.errors.generacion_procesador
                                                }>
                                                <SelectReact
                                    ...
                                    <div>
                                        ...
                                        {isEditting ? (
                                            ...
                                            <div className='ml-4'>
                                                {detalleEquipoEmpresa?.id_procesador ||
                                                    'Sin Identificador'}
                                            </div>
                                        )}
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        {isEditting ? (
                                            <Validation
                                                ...
                                                invalidFeedback={
                                                    formik.errors.marca_tarjeta_grafica
                                                }>
                                                <SelectReact
                                    ...
                                    <div>
                                        ...
                                        {isEditting ? (
                                            <Validation
                                                ...
                                                invalidFeedback={
                                                    formik.errors.tipo_tarjeta_grafica
                                                }>
                                                <SelectReact
                                    ...
                                    <div>
                                        ...
                                        {isEditting ? (
                                            <Validation
                                                ...
                                                invalidFeedback={
                                                    formik.errors.nombre_tarjeta_grafica
                                                }>
                                                <Input
                                    ...
                                    <div>
                                        ...
                                        {isEditting ? (
                                            <Validation
                                                ...
                                                invalidFeedback={
                                                    formik.errors.fecha_caducidad_garantia
                                                }>
                                                <Input
                                ...
                                <div className='grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5'>
                                    {activeComponent === 'Almacenamiento' && (
                                        <>
                                            ...
                                            {detalleEquipoEmpresa &&
                                                detalleEquipoEmpresa.datos_almacenamiento.length >
                                                    0 &&
                                                detalleEquipoEmpresa.datos_almacenamiento.map(
                                                            ...
                                                            <Badge className="text-xl">#{almacenamiento.id}</Badge>
                                                                ...
                                                                <CardBody className='grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5'>
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <div className='ml-4'>
                                                                            {dayjs(
                                                                                almacenamiento.fecha_instalacion,
                                                                            ).format('DD/MM/YYYY')}
                                                                        </div>
                                                                    </div>
                                                                    <div>
                                            ...
                                            {isEditting && (
                                                <div className='col-span-full grid gap-4 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5'>
                                                    ...
                                                    <div>
                                                        ...
                                                        <Validation
                                                            ...
                                                            isTouched={
                                                                formikAlmacenamiento.touched
                                                                    .almacenamiento
                                                            }
                                                            invalidFeedback={
                                                                formikAlmacenamiento.errors
                                                                    .almacenamiento
                                                            }>
                                                            <SelectReact
                                                                name='almacenamiento'
                                                                ...
                                                                value={TIPO_ALMACENAMIENTO.find(
                                                                    (alm) =>
                                                                        alm.value ===
                                                                        formikAlmacenamiento.values
                                                                            .almacenamiento,
                                                                )}
                                                                onChange={(e) => {
                                                                    formikAlmacenamiento.setFieldValue(
                                                                        'almacenamiento',
                                                                        (e as TSelectOption).value,
                                                                    );
                                                                }}
                                                    ...
                                                    <div>
                                                        ...
                                                        <Validation
                                                            ...
                                                            <Input
                                                                ...
                                                                onBlur={
                                                                    formikAlmacenamiento.handleBlur
                                                                }
                                                                onChange={
                                                                    formikAlmacenamiento.handleChange
                                                                }
                                                            />
                                                        </Validation>
                                                    </div>
                                                    ...
                                                    <div className='col-span-full'>
                                                        <Button
                                                            variant='solid'
                                                            onClick={() => {
                                                                formikAlmacenamiento.handleSubmit();
                                                            }}>
                                                            Crear Almacenamiento
                                                        </Button>
                                                    </div>
                                    ...
                                    {activeComponent === 'Softwares' && (
                                        <>
                                            ...
                                            {detalleEquipoEmpresa &&
                                                detalleEquipoEmpresa.datos_software.length > 0 &&
                                                detalleEquipoEmpresa.datos_software.map(
                                                    (software, index) => (
                                                        <div className='col-span-full' key={index}>
                                                            <Card className='border border-blue-500'>
                                                                <CardBody className='grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5'>
                                                ...
                                                <div className='col-span-full grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5'>
                                                    ...
                                                    <div>
                                                        ...
                                                        <Validation
                                                            ...
                                                            isTouched={
                                                                formikSoftware.touched.software_id
                                                            }
                                                            invalidFeedback={
                                                                formikSoftware.errors.software_id
                                                            }>
                                                            <SelectReact
                                                                name='software_id'
                                                    ...
                                                    <div>
                                                        ...
                                                        <Validation
                                                            isValid={formikSoftware.isValid}
                                                            isTouched={
                                                                formikSoftware.touched.version
                                                            }
                                                            invalidFeedback={
                                                                formikSoftware.errors.version
                                                            }>
                                                            <Input
                                                                name='version'
                                                                onBlur={formikSoftware.handleBlur}
                                                                onChange={
                                                                    formikSoftware.handleChange
                                                                }
                                                                value={
                                                                    formikSoftware.values.version
                                                                }
                                                            />
                                                        </Validation>
                                                    </div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <Validation
                                                            isValid={formikSoftware.isValid}
                                                            isTouched={
                                                                formikSoftware.touched.observaciones
                                                            }
                                                            invalidFeedback={
                                                                formikSoftware.errors.observaciones
                                                            }>
                                                            <Textarea
                                                                name='observaciones'
                                                                onBlur={formikSoftware.handleBlur}
                                    ...
                                    {activeComponent === 'Monitores' && (
                                        <>
                                            ...
                                            {detalleEquipoEmpresa &&
                                                detalleEquipoEmpresa.datos_monitor.length > 0 &&
                                                detalleEquipoEmpresa.datos_monitor.map(
                                                    (monitor, index) => (
                                                        <div className='col-span-full' key={index}>
                                                            <Card className='border border-blue-500'>
                                                                <CardBody className='grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5'>
                                                ...
                                                <div className='col-span-full grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5'>
                                                    ...
                                                    <div>
                                                        ...
                                                        <Validation
                                                            ...
                                                            invalidFeedback={
                                                                formikMonitor.errors.nombre
                                                            }>
                                                            <Input
                                                                name='nombre'
                                                                onBlur={formikMonitor.handleBlur}
                                                                onChange={
                                                                    formikMonitor.handleChange
                                                                }
                                                    ...
                                                    <div>
                                                        ...
                                                        <Validation
                                                            isValid={formikMonitor.isValid}
                                                            isTouched={
                                                                formikMonitor.touched.numero_serie
                                                            }
                                                            invalidFeedback={
                                                                formikMonitor.errors.numero_serie
                                                            }>
                                                            <Input
                                                                name='numero_serie'
                                                                onBlur={formikMonitor.handleBlur}
                                                    ...
                                                    <div>
                                                        ...
                                                        <Validation
                                                            isValid={formikMonitor.isValid}
                                                            isTouched={
                                                                formikMonitor.touched.accesorios
                                                            }
                                                            invalidFeedback={
                                                                formikMonitor.errors.accesorios
                                                            }>
                                                            <Input
                                                                name='accesorios'
                                                                onBlur={formikMonitor.handleBlur}
                                                                ...
                                                                value={
                                                                    formikMonitor.values.accesorios
                                                                }
                                                            />
                                                        </Validation>
                                                    </div>
                                                    <div>
                                                        ...
                                                        <Validation
                                                            isValid={formikMonitor.isValid}
                                                            isTouched={
                                                                formikMonitor.touched.observaciones
                                                            }
                                                            invalidFeedback={
                                                                formikMonitor.errors.observaciones
                                                            }>
                                                            <Textarea
                                                                name='observaciones'
                                                                onBlur={formikMonitor.handleBlur}
