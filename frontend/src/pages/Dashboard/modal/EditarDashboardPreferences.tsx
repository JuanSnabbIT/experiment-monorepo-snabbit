                ...
                <ModalBody>
                    <div className='flex flex-col gap-4'>
                        <div className='flex w-full items-center gap-2'>
                            ...
                            <Checkbox
                                variant='switch'
                                checked={formik.values.indicadores_economicos}
                                onChange={(e) => {
                        ...
                        <div className='flex w-full items-center gap-2'>
                            ...
                            <Checkbox
                                variant='switch'
                                checked={formik.values.empresa_seleccionada}
                                onChange={(e) => {
                                    formik.setFieldValue('empresa_seleccionada', e.target.checked);
                                }}></Checkbox>
                        </div>
                        <div className='flex w-full items-center gap-2'>
                            Ultimas actualizaciondes de OC{' '}
                            <Checkbox
                                variant='switch'
                                checked={formik.values.actualizaciones_oc}
                                onChange={(e) => {
                                    formik.setFieldValue('actualizaciones_oc', e.target.checked);
                                }}></Checkbox>
                        </div>
                        <div className='flex w-full items-center gap-2'>
                            Ultimos Eventos{' '}
                            <Checkbox
                                variant='switch'
                                checked={formik.values.ultimos_eventos}
                                onChange={(e) => {
                                    formik.setFieldValue('ultimos_eventos', e.target.checked);
                                }}></Checkbox>
                        </div>
                    </div>
                </ModalBody>
