...
//                                         }}>
//                                         <div className="text-lg font-semibold text-gray-700">{user.nombre_usuario}</div>
//                                         <div className="text-sm text-gray-500"><strong>Tipo de Equipo:</strong> {user.datos_equipo.tipo_equipo_label}</div>
//                                         <div className="text-sm text-gray-500"><strong>Marca:</strong> {user.datos_equipo.marca_label}</div>
//                                         <div className="text-sm text-gray-500"><strong>Tipo de Procesador:</strong> {user.datos_equipo.tipo_procesador_label}</div>
//                                         <div className="text-sm text-gray-500"><strong>Fecha de Asignación:</strong> {dayjs(user.fecha_asignacion).format('DD/MM/YYYY')}</div>
//                                         <div className="text-sm text-gray-500"><strong>Fecha de Devolución:</strong> {user.fecha_devolucion ? dayjs(user.fecha_devolucion).format('DD/MM/YYYY') : 'N/A'}</div>
//                                         <div className="text-sm text-gray-500"><strong>Observaciones:</strong> {user.observaciones}</div>
//                                     </div>
//                                 </SwiperSlide>
//                             ))}
//                     </Swiper>
//                 ) : (
//                     <div className="text-center text-gray-500">No hay usuarios asignados</div>
//                 )}
//             </div>
