                        ...
                        <Timeline>
                            {listaUsuariosDelEquipo.map((userEquipo, index) => (
                                <TimelineItem
                                    ...
                                    <Badge className='flex items-center gap-2'>
                                        ...
                                        <Tooltip text={userEquipo.estado ? 'Asignado' : 'Devuelto'}>
                                            <Icon
                                                ...
                                                color={
                                                    userEquipo.estado ? 'emerald' : 'red'
                                                }></Icon>
                                        </Tooltip>
                                    </Badge>
                                    <div>
                                        Fecha de Asignación:{' '}
                                        {userEquipo.fecha_asignacion
                                            ? dayjs(userEquipo.fecha_asignacion).format(
                                                  'DD/MM/YYYY',
                                              )
                                    ...
                                    <div>
                                        Fecha de Devolución:{' '}
                                        {userEquipo.fecha_devolucion
                                            ? dayjs(userEquipo.fecha_devolucion).format(
                                                  'DD/MM/YYYY',
                                              )
                                        ...
                                        {userEquipo.observaciones.length > 0 ? (
                                            <>
                                                ...
                                                <div className='flex flex-col p-2'>
                                                    <Collapse
                                                        isOpen={equipoAbierto === userEquipo.id}
