    ...
    return (
        <Card>
            ...
            <CardBody className='flex flex-col gap-4'>
                {detalleEquipoEmpresa && detalleEquipoEmpresa.datos_almacenamiento.length > 0 ? (
                    detalleEquipoEmpresa.datos_almacenamiento.map((almacenamiento, index) => (
                        <div key={index} className='rounded-xl border border-blue-500'>
                            <div className='grid grid-cols-2 gap-4 p-4 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5'>
                                ...
                                <div>
                                    ...
                                    <div className='ml-4'>
                                        {dayjs(almacenamiento.fecha_instalacion).format(
                                            'DD/MM/YYYY',
                                        )}
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div className='ml-4'>
                                        {almacenamiento.adicional ? 'Si' : 'No'}
                                    </div>
                                </div>
                                <div>
                                    <Badge>Observaciones</Badge>
                                    <div className='ml-4'>
                                        {almacenamiento.observaciones || 'Sin Observaciones'}
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <Validation
                                ...
                                <SelectReact
                                    ...
                                    value={TIPO_ALMACENAMIENTO.find(
                                        (alm) =>
                                            alm.value ===
                                            formikAlmacenamiento.values.almacenamiento,
                                    )}
                                    onChange={(e) => {
