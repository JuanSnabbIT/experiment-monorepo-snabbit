...
const validationSchema = Yup.object().shape({
    ...
    fecha_compra: Yup.date().nullable().typeError('Debe ser una fecha válida'),

    fecha_caducidad_garantia: Yup.date().nullable().typeError('Debe ser una fecha válida'),

    asignado_a: Yup.string().nullable(),

    condicion_equipo: Yup.string()
...
function CrearEquipoAlCliente() {
    ...
    useEffect(() => {
        if (listaUsuariosTodaLaEmpresa.length > 0) {
            setOptionsUsuarios(
                listaUsuariosTodaLaEmpresa.map((user) => {
        ...
        onSubmit: async (values) => {
            try {
                ...
                if (response.data) {
                    ...
                    dispatch(
                        listaEquiposEmpresaThunk({ id_empresa: personalizacionUsuario?.empresa }),
                    );
                    setIsOpen(false);
                }
            } catch (error: any) {
                        ...
                        <Validation
                            ...
                            <SelectReact
                                ...
                                value={{
                                    ...
                                    label:
                                        TIPO_EQUIPO.find(
                                            (equ) => equ.value === formik.values.tipo_equipo,
                                        )?.label || 'Sin Tipo',
                                }}
                                onChange={(e) => {
                                    formik.setFieldValue('tipo_equipo', (e as TSelectOption).value);
                                }}
                                onBlur={formik.handleBlur}
                            />
                        </Validation>
                        ...
                        <Validation
                            ...
                            <SelectReact
                                ...
                                value={{
                                    ...
                                    label:
                                        MARCA_EQUIPO.find(
                                            (equ) => equ.value === formik.values.marca,
                                        )?.label || 'Sin Marca',
                                }}
                                onChange={(e) => {
                                    formik.setFieldValue('marca', (e as TSelectOption).value);
                                }}
                                onBlur={formik.handleBlur}
                            />
                        </Validation>
                                ...
                                value={{
                                    ...
                                    label:
                                        CONDICIONES_EQUIPO.find(
                                            (equ) => equ.value === formik.values.condicion_equipo,
                                        )?.label || 'Sin Condicion',
                                }}
                                onChange={(e) => {
                                ...
                                value={{
                                    ...
                                    label:
                                        TIPO_PROCESADOR.find(
                                            (equ) => equ.value === formik.values.tipo_procesador,
                                        )?.label || 'Sin Tipo Procesador',
                                }}
                                onChange={(e) => {
                                    formik.setFieldValue(
                                        'tipo_procesador',
                                ...
                                value={{
                                    ...
                                    label:
                                        GENERACION_PROCESADOR.find(
                                            (equ) =>
                                                equ.value === formik.values.generacion_procesador,
                                        )?.label || 'Sin Generacion',
                                }}
                                onChange={(e) => {
                                    formik.setFieldValue(
                                        'generacion_procesador',
                        ...
                        <Validation
                            ...
                            <SelectReact
                                ...
                                value={{
                                    ...
                                    label:
                                        TAMANIO_RAM.find((equ) => equ.value === formik.values.ram)
                                            ?.label || 'Sin Ram',
                                }}
                                onChange={(e) => {
                                    formik.setFieldValue('ram', (e as TSelectOption).value);
                                }}
                                onBlur={formik.handleBlur}
                            />
                        </Validation>
                                ...
                                value={{
                                    ...
                                    label:
                                        SISTEMA_OPERATIVO.find(
                                            (equ) => equ.value === formik.values.sistema_operativo,
                                        )?.label || 'Sin Condicion',
                                }}
                                onChange={(e) => {
                                    formik.setFieldValue(
                        ...
                        <Validation
                            ...
                            <SelectReact
                                ...
                                value={{
                                    ...
                                    label:
                                        optionsUsuarios.find(
                                            (equ) => equ.value === formik.values.asignado_a,
                                        )?.label || 'Sin Asignacion',
                                }}
                                onChange={(e) => {
                                    formik.setFieldValue('asignado_a', (e as TSelectOption).value);
                                }}
                                onBlur={formik.handleBlur}
                            />
                        </Validation>
                        {formik.values.asignado_a != '' &&
                            listaUsuariosTodaLaEmpresa.some(
                                (user) => user.id.toString() === formik.values.asignado_a,
                            ) && (
                                <div className='w-full'>
                                    Nombre:{' '}
                                    {
                                        listaUsuariosTodaLaEmpresa.find(
                                            (user) =>
                                                user.id.toString() === formik.values.asignado_a,
                                        )?.nombre_usuario
                                    }
                                    , Rut:{' '}
                                    {
