...
function AceptarInvitacionEmpresa() {
    ...
    return (
        <PageWrapper
            ...
            title='Aceptar Invitacion a Empresa'
            name='Aceptar Invitacion a Empresa'>
                ...
                <div className='flex max-w-xl flex-col gap-4'>
                    ...
                    <div>
                        <span className='text-4xl font-semibold'>
                            Has sido invitado a unirte a Gestion Snabbit.
                        </span>
                    </div>
                    <div>
                        <p>
                            Donde podrás interactuar y operar dentro de nuestra plataforma de
                            gestión.
                        </p>
                        ...
                        <p>
                            Una vez creada la contraseña, tendrás acceso inmediato a todas las
                            funciones que te ayudarán a gestionar tus actividades de manera
                            eficiente.
                        </p>
                    </div>
