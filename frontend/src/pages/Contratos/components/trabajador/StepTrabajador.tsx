    ...
    return (
        <div className='space-y-4'>
            ...
            {values.trab_modo === 'existente' ? (
                <div>
                    <Label htmlFor='trab_usuario_empresa_id'>Trabajador</Label>
                    <SelectReact
                    ...
                    />
                    <Validation
                        isValid={!!touched.trab_usuario_empresa_id && !errors.trab_usuario_empresa_id}
                        isTouched={!!touched.trab_usuario_empresa_id}
                        invalidFeedback={errors.trab_usuario_empresa_id || ''}
                    >
                        <div />
                    </Validation>
                </div>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-3'>
                    <div>
                        <Label htmlFor='trab_first_name'>Nombres</Label>
                        <Input
                            id='trab_first_name'
                    ...
                    <div>
                        <Label htmlFor='trab_email'>Email</Label>
                        <Input
                            id='trab_email'
                            name='trab_email'
                            type='email'
                    ...
                    <div className='md:col-span-2'>
                        <Label htmlFor='trab_sucursal_id'>Sucursal</Label>
                        <SelectReact
