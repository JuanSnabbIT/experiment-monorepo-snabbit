...
function EditarConfidencialidadContrato({firma} : {firma: IFirmaConfidencialidad}) {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            try {
                const response = await ApiService.fetchData({url: `/api/contratos/${detalleContratoEmpresaCliente?.id}/firmas/${firma.id}/`, method: 'patch', headers: {'Content-Type': 'application/json'}, data: JSON.stringify(payload)});
                if (response.data) {
            ...
            <Modal isOpen={isOpen} setIsOpen={setIsOpen} isStaticBackdrop={true}>
                ...
                <ModalFooter>
                    ...
                    <ModalFooterChild>
                        ...
                        <Button variant="solid" onClick={() => {formik.handleSubmit()}}>Editar</Button>
                    </ModalFooterChild>
                </ModalFooter>
            </Modal>
        </>
