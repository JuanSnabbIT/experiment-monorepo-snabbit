...
function ItemsTablaDeUsuariosVinculadosLicencias({ user }: { user: IUsuarioVinculadoLicencia }) {
    ...
    const { detalleContratoLicencia, listaUsuariosDisponiblesLicencia } = useAppSelector(
        ...
        onSubmit: async (values) => {
            try {
                ...
                const response = await ApiService.fetchData({
                    url: `/api/contrato-licencias/${detalleContratoLicencia?.id}/usuarios-vinculados/${user.id}/`,
                    method: 'patch',
                ...
                toast.error(mensajesError || 'Error al editar el usuario', {
                    toastId: 'Error al editar el usuario',
                });
            }
        },
    });
    ...
    return (
        <>
            <div className='grid grid-cols-3 rounded-xl border border-blue-500'>
                <div className='flex flex-col gap-2 border-r border-r-blue-500 p-4'>
                    {editando ? (
                        <>
                            <div>
                                ...
                                <Validation
                                    ...
                                    <SelectReact
                                        ...
                                        options={listaUsuariosDisponiblesLicencia.map((user) => ({
