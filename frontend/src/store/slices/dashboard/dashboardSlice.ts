...
export const ultimosValoresIndicadoresThunk = createAsyncThunk<IndicadoresEconomicos, undefined, {rejectValue: string}>(
    'dashboard/ultimosValoresIndicadoresThunk',
    async (_, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<IndicadoresEconomicos>({baseURL: `https://mindicador.cl`, url: '/api', method: 'get', isLoginRequest: true})
