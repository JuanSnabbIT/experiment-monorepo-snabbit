...
import { ICampoAdicionalItem, ICategoria, IFabricante, IItem, IItemEmpresa, IProveedorEmpresa } from "@/interface/items.interface"
...
export const listaCamposAdicionalesItemThunk = createAsyncThunk<ICampoAdicionalItem[], {id_empresa: number | string | undefined}, {rejectValue: string}>(
    'item/listaCamposAdicionalesItemThunk',
    async ({id_empresa}, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<ICampoAdicionalItem[]>({url: `/api/campos-adicionales-items/por-empresa/${id_empresa}/`, method: 'get'})
...
export const listaProveedoresDelItemThunk = createAsyncThunk<IProveedorEmpresa[], {id_item: number | string | undefined}, {rejectValue: string}>(
    'item/listaProveedoresDelItemThunk',
    async ({id_item}, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<IProveedorEmpresa[]>({url: `/api/items-empresa/${id_item}/proveedores`, method: 'get'})
            return response.data
        } catch (error: any) {
...
export const listaProveedoresNoAsociadosAItemEspecificoThunk = createAsyncThunk<IProveedorEmpresa[], {id_item: number | string | undefined}, {rejectValue: string}>(
    'item/listaProveedoresNoAsociadosAItemEspecificoThunk',
    async ({id_item}, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<IProveedorEmpresa[]>({url: `/api/proveedores-empresa/no_asociados_a_item/`, method: 'get', params: {item_id: id_item}})
            return response.data
        } catch (error: any) {
...
export const listaOrdenesCompraRecientesItemThunk = createAsyncThunk<IOrdenCompra[], {id_item: number | string | undefined, dias: number}, {rejectValue: string}>(
    'item/listaOrdenesCompraRecientesItemThunk',
    async ({dias, id_item}, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<IOrdenCompra[]>({url: `/api/ordenes-compra/recientes-por-item/?item_id=${id_item}&dias=${dias}`, method: 'get'})
            return response.data
        } catch (error: any) {
            return rejectWithValue(error.response.data)
        }
...
export const listaItemsNoProveedorThunk = createAsyncThunk<IItemEmpresa[], {id_proveedor: string | number | undefined, id_empresa: null | string | number | undefined}, {rejectValue: string}>(
...
export const detalleProveedorEmpresaThunk = createAsyncThunk<IProveedorEmpresa, {id_proveedor: number | string | undefined | null, id_empresa: null | number | string | undefined}, {rejectValue: string}>(
...
export const listaOrdenesCompraRecientesProveedorThunk = createAsyncThunk<IOrdenCompra[], {id_proveedor: number | string | undefined, dias: number}, {rejectValue: string}>(
    'item/listaOrdenesCompraRecientesProveedorThunk',
    async ({id_proveedor, dias}, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<IOrdenCompra[]>({url: `/api/ordenes-compra/recientes-por-proveedor/?proveedor_id=${id_proveedor}&dias=${dias}`, method: 'get'})
            return response.data
        } catch (error: any) {
            return rejectWithValue(error.response.data)
        }
...
export const listaItemsEmpresaFiltroThunk = createAsyncThunk<IItemEmpresa[], {id_empresa: string | number | undefined | null, filtro?: URLSearchParams}, {rejectValue: string}>(
    'item/listaItemsEmpresaFiltroThunk',
    async ({id_empresa, filtro}, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<IItemEmpresa[]>({url: `/api/empresas/${id_empresa}/items-empresa/`, method: 'get', params: filtro ? filtro : undefined})
            return response.data
        } catch (error: any) {
            return rejectWithValue(error.response.data)
        }
