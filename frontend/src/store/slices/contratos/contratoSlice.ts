import { ICondicionEspecial, IContratoEmpresaCliente, IContratoLicencia, IContratoServicio, IDetalleEnvio, IFirmaConfidencialidad, ILicencia, IPlanServicio, IServicio, IUsuarioVinculadoLicencia, IVisita } from "@/interface/contrato.interface"
...
export const detalleFirmaContratoThunk = createAsyncThunk<IDetalleEnvio, {uuid_envio: string | undefined}, {rejectValue: string}>(
    'contrato/detalleFirmaContratoThunk',
    async ({uuid_envio}, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<IDetalleEnvio>({url: `/api/acuerdos-por-envio/${uuid_envio}/`, isLoginRequest: true})
...
export const detalleContratoLicenciaThunk = createAsyncThunk<IContratoLicencia, {id_licencia: string | number | undefined}, {rejectValue: string}>(
    'contrato/detalleContratoLicenciaThunk',
    async ({id_licencia}, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<IContratoLicencia>({url: `/api/contrato-licencias/${id_licencia}/`, method: 'get'})
            return response.data
        } catch (error: any) {
...
export const listaUsuariosDisponiblesLicenciaThunk = createAsyncThunk<IUsuarioEmpresa[], {id_licencia: string | number | undefined, id_empresa: string | number | undefined}, {rejectValue: string}>(
    'contrato/listaUsuariosDisponiblesLicenciaThunk',
    async ({id_licencia, id_empresa}, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<IUsuarioEmpresa[]>({url: `/api/contrato-licencias/${id_licencia}/usuarios-vinculados/empresa/${id_empresa}/usuarios-no-vinculados/`, method: 'get'})
            return response.data
        } catch (error: any) {
            return rejectWithValue(error.response.data || "Error al obtener los usuarios disponibles") 
        }
    }
)

export const listaUsuariosVinculadosLicenciaThunk = createAsyncThunk<IUsuarioVinculadoLicencia[], {id_licencia: number | string | undefined}, {rejectValue: string}>(
    'contrato/listaUsuariosVinculadosLicenciaThunk',
    async ({id_licencia}, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<IUsuarioVinculadoLicencia[]>({url: `/api/contrato-licencias/${id_licencia}/usuarios-vinculados/`, method: 'get'})
            return response.data
        } catch (error: any) {
...
export const listaContratoLicenciaDeEmpresaYClienteThunk = createAsyncThunk<IContratoLicencia[], {id_cliente: number | string | undefined, id_empresa: number | string | undefined}, {rejectValue: string}>(
    'contrato/listaContratoLicenciaDeEmpresaYClienteThunk',
    async ({id_cliente, id_empresa}, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<IContratoLicencia[]>({url: `/api/contrato-licencias/lista-vinculos/${id_empresa}/${id_cliente}/`, method: 'get'})
            return response.data
        } catch (error: any) {
...
export const listaContratosDeEmpresaYClienteThunk = createAsyncThunk<IContratoEmpresaCliente[], {id_empresa: number | string | undefined, id_cliente: number | string | undefined}, {rejectValue: string}>(
    'contrato/listaContratosDeEmpresaYClienteThunk',
    async ({id_cliente, id_empresa}, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<IContratoEmpresaCliente[]>({url: `/api/contratos/filtrar-por-empresa-cliente/${id_empresa}/${id_cliente}/`, method: 'get'})
            return response.data
        } catch (error: any) {
...
export const detalleContratoEmpresaClienteThunk = createAsyncThunk<IContratoEmpresaCliente, {id_contrato: number | string | undefined | null}, {rejectValue: string}>(
    'contrato/detalleContratoEmpresaClienteThunk',
    async ({id_contrato}, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<IContratoEmpresaCliente>({url: `/api/contratos/${id_contrato}/`, method: 'get'})
            return response.data
        } catch (error: any) {
...
export const listaFirmasConfidencialidadThunk = createAsyncThunk<IFirmaConfidencialidad[], {id_contrato: number | string | undefined | null}, {rejectValue: string}>(
    'contrato/listaFirmasConfidencialidadThunk',
    async ({id_contrato}, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<IFirmaConfidencialidad[]>({url: `/api/contratos/${id_contrato}/firmas/`, method: 'get'})
            return response.data
        } catch (error: any) {
            return rejectWithValue(error.response.data || "Error al obtener las firmas de confidencialidad")
        }
    }
)

export const listaCondicionesEspecialesThunk = createAsyncThunk<ICondicionEspecial[], undefined, {rejectValue: string}>(
    'contrato/listaCondicionesEspecialesThunk',
    async (_, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<ICondicionEspecial[]>({url: `/api/condiciones-especiales`, method: 'get'})
            return response.data
        } catch (error: any) {
            return rejectWithValue(error.response.data || "Error al obtener las condiciones especiales")
        }
    }
)
...
export const listaVisitasThunk = createAsyncThunk<IVisita[], undefined, {rejectValue: string}>(
    ...
    async (_, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<IVisita[]>({url: `/api/visitas`, method: 'get'})
            return response.data
        } catch (error: any) {
...
export const listaLicenciasThunk = createAsyncThunk<ILicencia[], undefined, {rejectValue: string}>(
    'contrato/listaLicenciasThunk',
    async (_, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<ILicencia[]>({url: `/api/licencias`, method: 'get'})
            return response.data
        } catch (error: any) {
            return rejectWithValue(error.response.data || "Error al obtener las licencias")
        }
...
export const listaServiciosThunk = createAsyncThunk<IServicio[], undefined, {rejectValue: string}>(
    'contrato/listaServiciosThunk',
    async (_, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<IServicio[]>({url: `/api/servicios`, method: 'get'})
            return response.data
        } catch (error: any) {
...
export const listaPlanServiciosThunk = createAsyncThunk<IPlanServicio[], undefined, {rejectValue: string}>(
    'contrato/listaPlanServiciosThunk',
    async (_, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<IPlanServicio[]>({url: `/api/planes-servicio`, method: 'get'})
            return response.data
        } catch (error: any) {
...
export const listaContratoServicioThunk = createAsyncThunk<IContratoServicio[], {id_contrato: number | string | undefined}, {rejectValue: string}>(
    'contrato/listaContratoServicioThunk',
    async ({id_contrato}, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<IContratoServicio[]>({url: `/api/contratos/${id_contrato}/servicios/`, method: 'get'})
            return response.data
        } catch (error: any) {
            return rejectWithValue(error.response.data || "Error al obtener los servicios")
        }
...
export const { LIMPIAR_DETALLE_CONTRATO, LIMPIAR_USUARIOS_VINCULADOS_LICENCIA, LIMPIAR_DETALLE_LICENCIA } = contratoSlice.actions
