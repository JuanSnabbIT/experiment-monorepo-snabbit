...
export const listaVisitasSoporteThunk = createAsyncThunk<IVisitaSoporte[], undefined, {rejectValue: string}>(
    'visitas/listaVisitasSoporteThunk',
...
export const detalleVisitaSoporteThunk = createAsyncThunk<IVisitaSoporte, {id_visita: number | string | undefined}, {rejectValue: string}>(
    'visitas/detalleVisitaSoporteThunk',
    async ({id_visita}, {rejectWithValue}) =>{
        try {
...
export const listaAsistenciaUsuariosThunk = createAsyncThunk<IAsistenciaUsuario[], {id_visita: number | string | undefined}, {rejectValue: string}>(
    'visitas/listaAsistenciaUsuariosThunk',
    async ({id_visita}, {rejectWithValue}) =>{
        try {
...
export const detalleAsistenciaUsuarioThunk = createAsyncThunk<IAsistenciaUsuario, {id_visita: number | string | undefined, id_usuario: number | string | undefined}, {rejectValue: string}>(
...
export const listaUsuarioEquipoAsistenciaThunk = createAsyncThunk<IUsuarioEquipo[],{ id_visita: number | string | undefined },{ rejectValue: string }>(
    'visitas/listaUsuarioEquipoAsistenciaThunk',
    async ({ id_visita }, { rejectWithValue }) => {
        try {
...
export const detalleUsuarioEquipoAsistenciaThunk = createAsyncThunk<IUsuarioEquipo,{ id_visita: number | string; id_usuario: number | string },{ rejectValue: string }>(
...
export const listaEntregaEquipoThunk = createAsyncThunk<IEntregaEquipo[],{ id_visita: number | string | undefined },{ rejectValue: string }>(
    'visitas/listaEntregaEquipoThunk',
    async ({ id_visita }, { rejectWithValue }) => {
        try {
...
export const detalleEntregaEquipoThunk = createAsyncThunk<IEntregaEquipo,{ id_visita: number | string; id_usuario: number | string },{ rejectValue: string }>(
  'visitas/detalleEntregaEquipoThunk',
    async ({ id_visita, id_usuario }, { rejectWithValue }) => {
        try {
...
export const listaInsumosEnVisitaSoporteThunk = createAsyncThunk<IInsumoEnVisitaSoporte[], {id_visita: number | string | undefined}, {rejectValue: string}>(
    'visitas/listaInsumosEnVisitaSoporteThunk',
    async ({id_visita}, {rejectWithValue}) => {
        try {
...
export const listaDeEquiposParaEntregarThunk = createAsyncThunk<IEquipo[], {id_guia_salida: string | number | undefined | null}, {rejectValue: string}>(
    'visitas/listaDeEquiposParaEntregarThunk',
    async ({id_guia_salida}, {rejectWithValue}) => {
        try {
...
export const listaTodosAsistenciaUsuariosThunk = createAsyncThunk<IAsistenciaUsuario[], undefined, { rejectValue: string }>(
    'visitas/listaTodosAsistenciaUsuariosThunk',
    async (_, { rejectWithValue }) => {
        try {
