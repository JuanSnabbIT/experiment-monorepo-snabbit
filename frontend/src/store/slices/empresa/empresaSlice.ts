import { IEmpresa, IRelacionEmpresa, ISucursalEmpresa, IUltimasActividadesUsuarioEmpresa, IUsuarioEmpresa } from "@/interface/empresas.interface"
...
export const listaUsuariosEmpresaYClienteThunk = createAsyncThunk<IUsuarioEmpresa[], {ids_empresa: number[]}, {rejectValue: string}>(
    'empresa/listaUsuariosEmpresaYClienteThunk',
    async ({ids_empresa}, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<IUsuarioEmpresa[], string>({url: `/api/usuarios-empresa/usuarios_por_empresas/`, method: 'post', headers: {'Content-Type': 'application/json'}, data: JSON.stringify({empresa_ids: ids_empresa})})
...
export const listaUsuariosDeMisClientesThunk = createAsyncThunk<IUsuarioEmpresa[], {id_empresa: number | string | undefined}, {rejectValue: string}>(
    'empresa/listaUsuariosDeMisClientesThunk',
    async ({id_empresa}, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<IUsuarioEmpresa[]>({url: `/api/empresas/${id_empresa}/usuarios-de-clientes/`, method: 'get'})
            return response.data
        } catch (error: any) {
...
export const listaUsuariosTodaLaEmpresaThunk = createAsyncThunk<IUsuarioEmpresa[], {id_empresa: number | string | undefined}, {rejectValue: string}>(
    'empresa/listaUsuariosTodaLaEmpresaThunk',
    async ({id_empresa}, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<IUsuarioEmpresa[]>({url: `/api/empresas/${id_empresa}/usuarios/`, method: 'get'})
            return response.data
        } catch (error: any) {
            return rejectWithValue(error.response.data)
        }
...
export const listaUsuariosTodoElClienteThunk = createAsyncThunk<IUsuarioEmpresa[], {id_empresa: number | string | undefined}, {rejectValue: string}>(
    'empresa/listaUsuariosTodoElClienteThunk',
    async ({id_empresa}, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<IUsuarioEmpresa[]>({url: `/api/empresas/${id_empresa}/usuarios/`, method: 'get'})
            return response.data
...
export const listaMisSucursalesThunk = createAsyncThunk<ISucursalEmpresa[], {id_empresa: number | string | undefined}, {rejectValue: string}>(
    'empresa/listaMisSucursalesThunk',
    async ({id_empresa}, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<ISucursalEmpresa[]>({url: `/api/empresas/${id_empresa}/sucursales/`, method: 'get'})
            return response.data
        } catch (error: any) {
            return rejectWithValue(error.response.data)
        }
...
export const listaUsuariosClienteThunk = createAsyncThunk<IUsuarioEmpresa[], {id_empresa: number | string | undefined, id_sucursal: string | number | undefined}, {rejectValue: string}>(
    'empresa/listaUsuariosClienteThunk',
    async ({id_empresa, id_sucursal}, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<IUsuarioEmpresa[]>({url: `/api/empresas/${id_empresa}/sucursales-empresa/${id_sucursal}/usuarios/`, method: 'get'})
            return response.data
        } catch (error: any) {
            return rejectWithValue(error.response.data)
        }
...
export const detalleClienteThunk = createAsyncThunk<IRelacionEmpresa, {id_relacion: string | number | undefined}, {rejectValue: string}>(
    'empresa/detalleClienteThunk',
    async ({id_relacion}, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<IRelacionEmpresa>({url: `/api/relaciones-empresa/${id_relacion}/`, method: 'get'})
            return response.data
        } catch (error: any) {
            return rejectWithValue(error.response.data)
        }
...
export const listaMisClientesThunk = createAsyncThunk<IRelacionEmpresa[], {id_empresa: number | string | undefined | null}, {rejectValue: string}>(
    'empresa/listaMisClientesThunk',
    async ({id_empresa}, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<IRelacionEmpresa[]>({url: `/api/empresas/${id_empresa}/mis-clientes`, method: 'get'})
            return response.data
        } catch (error: any) {
            return rejectWithValue(error.response.data)
        }
...
export const detalleSucursalThunk = createAsyncThunk<ISucursalEmpresa, {id_empresa: string | number | undefined; id_sucursal: string | number | undefined }, {rejectValue: string}>(
    'empresa/detalleSucursalThunk',
    async ({id_empresa, id_sucursal }, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<ISucursalEmpresa>({url: `/api/empresas/${id_empresa}/sucursales-empresa/${id_sucursal}/`, method: 'get'})
            return response.data
        } catch (error: any) {
            return rejectWithValue(error.response.data)
        }
...
export const usuarioEmpresaLogeadoThunk = createAsyncThunk<IUsuarioEmpresa, {id_usuario: string | number | undefined}, {rejectValue: string}>(
    'empresa/usuarioEmpresaLogeadoThunk',
    async ({id_usuario}, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<IUsuarioEmpresa>({url: `/api/usuarios-empresa/detalle-usuario/?usuario_id=${id_usuario}`, method: 'get'})
            return response.data
