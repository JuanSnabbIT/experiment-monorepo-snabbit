import { IEquipo, IFotoEquipo, ISoftware, ISoftwareDeEmpresa, IUsuarioEquipo } from "@/interface/recursos.interface"
...
export const listaEquiposEmpresaThunk = createAsyncThunk<IEquipo[], {id_empresa: number | string | undefined | null}, {rejectValue: string}>(
    'recursos/listaEquiposEmpresaThunk',
    async ({id_empresa}, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<IEquipo[]>({url: `/api/empresas/${id_empresa}/equipos/`, method: 'get'})
...
export const detalleEquipoEmpresaThunk = createAsyncThunk<IEquipo, {id_equipo: number | undefined | string}, {rejectValue: string}>(
    'recursos/detalleEquipoEmpresaThunk',
    async ({id_equipo}, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<IEquipo>({url: `/api/equipos/${id_equipo}/`, method: 'get'})
            return response.data
        } catch (error: any) {
            return rejectWithValue(error.response.data)
        }
...
export const listaUsuariosDelEquipoThunk = createAsyncThunk<IUsuarioEquipo[], {id_equipo: number | string | undefined}, {rejectValue: string}>(
    'recursos/listaUsuariosDelEquipoThunk',
    async ({id_equipo}, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<IUsuarioEquipo[]>({url: `/api/equipos/${id_equipo}/usuario-equipo/`, method: 'get'})
            return response.data
        } catch (error: any) {
            return rejectWithValue(error.response.data || "Error al obtener la lista de usuarios del equipo")
        }
    }
)

export const listaUsuariosDelEquipoPorClienteThunk = createAsyncThunk<IUsuarioEquipo[], {cliente_id: number | string | undefined}, {rejectValue: string}>(
    'recursos/listaUsuariosDelEquipoPorClienteThunk',
    async ({cliente_id}, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<IUsuarioEquipo[]>({url: `/api/usuarios-equipo/por-cliente/?cliente_id=${cliente_id}`, method: 'get'})
            return response.data
        } catch (error: any) {
            return rejectWithValue(error.response.data)
        }
...
export const listaEquiposDeMisClientesThunk = createAsyncThunk<IEquipo[], {id_empresa: number | string | undefined}, {rejectValue: string}>(
    'recursos/listaEquiposDeMisClientesThunk',
    async ({id_empresa}, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<IEquipo[]>({url: `/api/empresas/${id_empresa}/equipos-clientes`, method: 'get'})
            return response.data
        } catch (error: any) {
            return rejectWithValue(error.response.data)
        }
...
export const listaSoftwareThunk = createAsyncThunk<ISoftware[], undefined, {rejectValue: string}>(
    ...
    async (_, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<ISoftware[]>({url: `/api/softwares/`, method: 'get'})
            return response.data
        } catch (error: any) {
            return rejectWithValue(error.response.data)
        }
...
export const listaSoftwareDeEmpresaThunk = createAsyncThunk<ISoftwareDeEmpresa[], {id_empresa: number | string | undefined}, {rejectValue: string}>(
    'recursos/listaSoftwareDeEmpresaThunk',
    async ({id_empresa}, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<ISoftwareDeEmpresa[]>({url: `/api/software-empresa/empresa/${id_empresa}/`, method: 'get'})
            return response.data
        } catch (error: any) {
            return rejectWithValue(error.response.data || "Error al obtener la lista de softwares de empresa")
        }
    }
)

export const listaEquiposPorClienteThunk = createAsyncThunk<IEquipo[], { cliente_id: number | string | undefined }, { rejectValue: string }>(
    'recursos/listaEquiposPorClienteThunk',
    async ({ cliente_id }, { rejectWithValue }) => {
        try {
...
export const listaFotosDelEquipoThunk = createAsyncThunk<IFotoEquipo[], {id_equipo: string | number | undefined}, {rejectValue: string}>(
    'recursos/listaFotosDelEquipoThunk',
    async ({id_equipo}, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<[]>({url: `/api/equipos/${id_equipo}/fotos/`, method: 'get'})
            return response.data
        } catch (error: any) {
            return rejectWithValue(error.response.data)
        }
