import {
    ...
    IMovimientoStock,
    ITomaInventario,
    IItemEnTomaInventario,
    IEstadoTomaInventario,
    IVoucherDevolucion,
...
export const listaGuiasSalidasDisponiblesThunk = createAsyncThunk<
    IGuiaSalida[],
    { id_empresa: number | string | undefined },
    { rejectValue: string }
>('bodega/listaGuiasSalidasDisponiblesThunk', async ({ id_empresa }, { rejectWithValue }) => {
    try {
        const response = await ApiService.fetchData<IGuiaSalida[]>({
            url: `/api/guia-salida/${id_empresa}/disponibles`,
        });
...
export const buscarItemEnTomaInventarioThunk = createAsyncThunk<
    IItemEnTomaInventario[],
    { filtro: URLSearchParams },
    { rejectValue: string }
>('bodega/buscarItemEnTomaInventarioThunk', async ({ filtro }, { rejectWithValue }) => {
    try {
        const response = await ApiService.fetchData<IItemEnTomaInventario[]>({
            url: `/api/items-en-toma-inventario/buscar`,
            method: 'get',
            params: filtro,
        });
        return response.data;
        ...
        return rejectWithValue(
            error.response.data || 'Error al encontrar el item en toma inventario',
        );
    }
});

export const listaEstadosTomaInventarioThunk = createAsyncThunk<
    IEstadoTomaInventario[],
    { id_toma: string | number | undefined },
    { rejectValue: string }
>('bodega/listaEstadosTomaInventarioThunk', async ({ id_toma }, { rejectWithValue }) => {
    try {
        const response = await ApiService.fetchData<IEstadoTomaInventario[]>({
            url: `/api/tomas-inventario/${id_toma}/estados`,
            method: 'get',
        });
        return response.data;
    } catch (error: any) {
        return rejectWithValue(
            error.response.data || 'Error al obtener los estados de toma de inventario',
        );
    }
});

export const listaItemsEnTomaInventarioThunk = createAsyncThunk<
    IItemEnTomaInventario[],
    { id_toma: string | number | undefined },
    { rejectValue: string }
>('bodega/listaItemsEnTomaInventarioThunk', async ({ id_toma }, { rejectWithValue }) => {
    try {
        const response = await ApiService.fetchData<IItemEnTomaInventario[]>({
            url: `/api/tomas-inventario/${id_toma}/items/`,
            method: 'get',
        });
        return response.data;
    } catch (error: any) {
        return rejectWithValue(
            error.response.data || 'Error al obtener los items de toma de inventario',
        );
    }
});

export const detalleTomaInventarioThunk = createAsyncThunk<
    ITomaInventario,
    { id_toma: string | number | undefined },
    { rejectValue: string }
>('bodega/detalleTomaInventarioThunk', async ({ id_toma }, { rejectWithValue }) => {
    try {
        const response = await ApiService.fetchData<ITomaInventario>({
            url: `/api/tomas-inventario/${id_toma}/`,
            method: 'get',
        });
        return response.data;
    } catch (error: any) {
...
export const listaTomaInventarioFiltroThunk = createAsyncThunk<
    [],
    { filtro: URLSearchParams },
    { rejectValue: string }
>('bodega/listaTomaInventarioFiltroThunk', async ({ filtro }, { rejectWithValue }) => {
    try {
        const response = await ApiService.fetchData<[]>({
            url: `/api/tomas-inventario`,
            method: 'get',
            params: filtro,
        });
        return response.data;
        ...
        return rejectWithValue(
            error.response.data || 'Error al obtener la lista de tomas de inventarios',
        );
    }
});

export const listaTomaInventarioThunk = createAsyncThunk<
    ITomaInventario[],
    undefined,
    { rejectValue: string }
>('bodega/listaTomaInventarioThunk', async (_, { rejectWithValue }) => {
    try {
        const response = await ApiService.fetchData<ITomaInventario[]>({
            url: `/api/tomas-inventario`,
            method: 'get',
...
export const listaMovimientosStockThunk = createAsyncThunk<
    IMovimientoStock[],
    { id_item: number | string | undefined; id_empresa: string | number | undefined },
    { rejectValue: string }
>('bodega/listaMovimientosStockThunk', async ({ id_item, id_empresa }, { rejectWithValue }) => {
    try {
        const response = await ApiService.fetchData<IMovimientoStock[]>({
            url: `/api/empresas/${id_empresa}/items-empresa/${id_item}/movimientos/`,
            method: 'get',
        });
        return response.data;
    } catch (error: any) {
...
export const listaItemsCompraThunk = createAsyncThunk<
    IItemEnCompra[],
    { id_compra: string | number | undefined },
    { rejectValue: string }
>('bodega/listaItemsCompraThunk', async ({ id_compra }, { rejectWithValue }) => {
    try {
        const response = await ApiService.fetchData<IItemEnCompra[]>({
            url: `/api/compras/${id_compra}/items-compras/`,
            method: 'get',
        });
        return response.data;
    } catch (error: any) {
...
export const detalleCompraThunk = createAsyncThunk<
    ICompra,
    { id_compra: number | string | undefined },
    { rejectValue: string }
>('bodega/detalleCompraThunk', async ({ id_compra }, { rejectWithValue }) => {
    try {
        const response = await ApiService.fetchData<ICompra>({
            url: `/api/compras/${id_compra}/`,
            method: 'get',
        });
        return response.data;
    } catch (error: any) {
...
export const listaComprasDeStockThunk = createAsyncThunk<
    IItemOrdenCompraEnStock[],
    { id_bodega: string | number | undefined; id_stock: number | undefined | string },
    { rejectValue: string }
>('bodega/listaComprasDeStockThunk', async ({ id_bodega, id_stock }, { rejectWithValue }) => {
    try {
        const response = await ApiService.fetchData<IItemOrdenCompraEnStock[]>({
...
export const listaGuiaSalidaPorBodegaThunk = createAsyncThunk<
    IGuiaSalida[],
    { id_bodega: number | string | undefined },
    { rejectValue: string }
>('bodega/listaGuiaSalidaPorBodegaThunk', async ({ id_bodega }, { rejectWithValue }) => {
    try {
        const response = await ApiService.fetchData<IGuiaSalida[]>({
...
export const detalleBodegaThunk = createAsyncThunk<
    IBodega,
    { id_bodega: string | number | undefined },
    { rejectValue: string }
>('bodega/detalleBodegaThunk', async ({ id_bodega }, { rejectWithValue }) => {
    try {
        const response = await ApiService.fetchData<IBodega>({
            url: `/api/bodegas/${id_bodega}/`,
            method: 'get',
        });
        return response.data;
    } catch (error: any) {
...
export const listaEventosOcThunk = createAsyncThunk<
    IEventoOc[],
    undefined,
    { rejectValue: string }
>('bodega/obtenerEventosOcThunk', async (_, { rejectWithValue }) => {
    try {
        const response = await ApiService.fetchData<IEventoOc[]>({
            url: `/api/ordenes-compra/ultimos-eventos/`,
            method: 'get',
        });
        return response.data;
    } catch (error: any) {
...
export const listaItemsEnOrdenCompraThunk = createAsyncThunk<
    IItemEnOrdenCompra[],
    { id_orden: string | number | undefined },
    { rejectValue: string }
>('bodega/listaItemsEnOrdenCompraThunk', async ({ id_orden }, { rejectWithValue }) => {
    try {
        const response = await ApiService.fetchData<IItemEnOrdenCompra[]>({
            url: `/api/ordenes-compra/${id_orden}/items-en-orden-compra/`,
            method: 'get',
        });
        return response.data;
    } catch (error: any) {
...
export const listaMisOrdenesDeCompraThunk = createAsyncThunk<
    IOrdenCompra[],
    undefined,
    { rejectValue: string }
>('bodega/listaMisOrdenesDeCompraThunk', async (_, { rejectWithValue }) => {
    try {
...
export const listaItemsEnGuiaSalidaBodegaThunk = createAsyncThunk<
    IItemGuiaSalida[],
    { id_guia: string | number | undefined },
    { rejectValue: string }
>('bodega/listaItemsEnGuiaSalidaBodegaThunk', async ({ id_guia }, { rejectWithValue }) => {
    try {
        const response = await ApiService.fetchData<IItemGuiaSalida[]>({
            url: `/api/guia-salida/${id_guia}/items-guia/`,
            method: 'get',
        });
        return response.data;
    } catch (error: any) {
...
export const detalleGuiaSalidaBodegaThunk = createAsyncThunk<
    IGuiaSalida,
    { id_guia: string | number | undefined },
    { rejectValue: string }
>('bodega/detalleGuiaSalidaBodegaThunk', async ({ id_guia }, { rejectWithValue }) => {
    try {
        const response = await ApiService.fetchData<IGuiaSalida>({
            url: `/api/guia-salida/${id_guia}/`,
            method: 'get',
        });
        return response.data;
    } catch (error: any) {
...
export const listaStockItemsEnBodegaThunk = createAsyncThunk<
    IStockItemEnBodega[],
    { id_bodega: string | number | undefined },
    { rejectValue: string }
>('bodega/listaStockItemsEnBodegaThunk', async ({ id_bodega }, { rejectWithValue }) => {
    try {
        const response = await ApiService.fetchData<IStockItemEnBodega[]>({
...
export const listaGuiaSalidaBodegaThunk = createAsyncThunk<
    IGuiaSalida[],
    undefined,
    { rejectValue: string }
>('bodega/listaGuiaSalidaBodegaThunk', async (_, { rejectWithValue }) => {
    try {
        const response = await ApiService.fetchData<IGuiaSalida[]>({
            url: `/api/guia-salida`,
            method: 'get',
...
export const listaOrdenesCompraThunk = createAsyncThunk<
    IOrdenCompra[],
    { id_empresa: string | number | undefined | null; filtro?: URLSearchParams },
    { rejectValue: string }
>('bodega/listaOrdenesCompraThunk', async ({ id_empresa, filtro }, { rejectWithValue }) => {
    try {
        const response = await ApiService.fetchData<IOrdenCompra[]>({
...
export const detalleOrdenCompraThunk = createAsyncThunk<
    IOrdenCompra,
    { id_orden: string | number | undefined },
    { rejectValue: string }
>('bodega/detalleOrdenCompraThunk', async ({ id_orden }, { rejectWithValue }) => {
    try {
        const response = await ApiService.fetchData<IOrdenCompra>({
...
export const listaBodegasPorEmpresaThunk = createAsyncThunk<
    IBodega[],
    { id_empresa: number | string | undefined | null },
    { rejectValue: string }
>('bodega/listaBodegasPorEmpresaThunk', async ({ id_empresa }, { rejectWithValue }) => {
    try {
        const response = await ApiService.fetchData<IBodega[]>({
            url: `/api/bodegas/por-empresa/${id_empresa}/`,
            method: 'get',
        });
        return response.data;
    } catch (error: any) {
...
export const listaItemsOrdenCompraEnStockThunk = createAsyncThunk<
    IItemOrdenCompraEnStock[],
    { id_orden: string | number | undefined },
    { rejectValue: string }
>('bodega/listaItemsOrdenCompraEnStockThunk', async ({ id_orden }, { rejectWithValue }) => {
    try {
        const response = await ApiService.fetchData<IItemOrdenCompraEnStock[]>({
            url: `/api/ordenes-compra/${id_orden}/items-orden-compra-en-stock/por-orden/`,
            method: 'get',
        });
        return response.data;
    } catch (error: any) {
...
export const listaVouchersThunk = createAsyncThunk<
    ...
    { rejectValue: string }
>('bodega/listaVouchersThunk', async (filtros, { rejectWithValue }) => {
    try {
...
export const detalleVoucherThunk = createAsyncThunk<
    ...
    number,
    { rejectValue: string }
>('bodega/detalleVoucherThunk', async (voucherId, { rejectWithValue }) => {
    try {
