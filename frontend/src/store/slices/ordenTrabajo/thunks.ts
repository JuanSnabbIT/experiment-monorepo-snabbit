...
export const obtenerHistorialEstados = createAsyncThunk<
    IOrdenDeTrabajo['estado'] | undefined,
    number
>('ordentrabajo/obtenerHistorialEstados', async () => undefined);
...
export const updateEstado = createAsyncThunk<
    undefined,
    { id: number; estado: IOrdenDeTrabajo['estado'] | null }
>('ordentrabajo/updateEstado', async () => undefined);
