...
import { IAdjuntoDeOrden, ICheckCompletibilidad, IDetalleGastoRendicionOT, IDetalleOrdenDeTrabajo, IDetalleOrdenDeTrabajoCompra, IDetalleRetroalimentacionOT, IGuardadoParcialRetroalimentacion, IHistorialCambiosOrden, IHistorialSimple, IInsumo, IListaDetallesSeguimientosOT, IListaTrabajosFiltrado, IOrdenDeTrabajo, IRetroalimentacionOT, IRetroalimentacionSinPermisosOT, ISeguimientoOrden, IUsuarioVinculado } from "@/interface/ordenTrabajo.interface";
...
export const detalleRetroalimentacionOTThunk = createAsyncThunk<IDetalleRetroalimentacionOT, {id_retro: string | number | undefined}, {rejectValue: string}>(
    'ordenTrabajo/detalleRetroalimentacionOTThunk',
    async ({id_retro}, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<IDetalleRetroalimentacionOT>({url: `/api/retroalimentacion/${id_retro}/`, method: 'get'})
...
export const listaUsuariosVinculadosOTThunk = createAsyncThunk<IUsuarioVinculado[], {id_orden: string | number | undefined}, {rejectValue: string}>(
    'ordenTrabajo/listaUsuariosVinculadosOTThunk',
    async ({id_orden}, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<IUsuarioVinculado[]>({url: `/api/ordenes-trabajo/${id_orden}/usuarios-vinculados/`, method: 'get'})
            return response.data
        } catch (error: any) {
...
export const listaDetalleGastoRendicionOTDisponiblesThunk = createAsyncThunk<IDetalleGastoRendicionOT[], undefined, {rejectValue: string}>(
    'ordenTrabajo/listaDetalleGastoRendicionOTDisponiblesThunk',
    async (_, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<IDetalleGastoRendicionOT[]>({url: `/api/rendiciones/detalles-ot-libres/`, method: 'get'})
            return response.data
        } catch (error: any) {
...
export const listaDetalleGastoRendicionOTThunk = createAsyncThunk<IDetalleGastoRendicionOT[], {id_orden: string | number | undefined}, {rejectValue: string}>(
    'ordenTrabajo/listaDetalleGastoRendicionOTThunk',
    async ({id_orden}, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<[]>({url: `/api/ordenes-trabajo/${id_orden}/detalles-gastos/`, method: 'get'})
            return response.data
        } catch (error: any) {
            return rejectWithValue(error.response.data || "Error al obtener la lista de gastos")
        }
...
export const detalleSinPermisosRetroalimentacionOTThunk = createAsyncThunk<IRetroalimentacionSinPermisosOT, {uuid: string | undefined}, {rejectValue: string}>(
    'ordenTrabajo/detalleSinPermisosRetroalimentacionOTThunk',
    async ({uuid}, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<IRetroalimentacionSinPermisosOT>({url: `/api/retroalimentacion/pub/${uuid}/`, method: 'get', isLoginRequest: true})
            return response.data
        } catch (error: any) {
            return rejectWithValue(error.response.data || "Error al obtener el detalle de retroalimentación")
        }
    }
)

export const listaRetroalimentacionesOTThunk = createAsyncThunk<IRetroalimentacionOT[], {id_orden: string | number | undefined}, {rejectValue: string}>(
    'ordenTrabajo/listaRetroalimentacionesOTThunk',
    async ({id_orden}, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<[]>({url: `/api/ordenes-trabajo/${id_orden}/retroalimentaciones/`, method: 'get'})
            return response.data
        } catch (error: any) {
...
export const checkCompletibilidadOTThunk = createAsyncThunk<ICheckCompletibilidad, {id_orden: string | number | undefined}, {rejectValue: string}>(
    'ordenTrabajo/checkCompletibilidadOTThunk',
    async ({id_orden}, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<ICheckCompletibilidad>({url: `/api/ordenes-trabajo/${id_orden}/check-completabilidad`, method: 'get'})
            return response.data
        } catch (error: any) {
            return rejectWithValue(error.response.data || "Error al obtener el check de completibilidad")
        }
    }
)

export const listaTecnicosThunk = createAsyncThunk<IUsuarioEmpresa[], {id_empresa: string | number | undefined}, {rejectValue: string}>(
    'ordenTrabajo/listaTecnicosThunk',
    async ({id_empresa}, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<IUsuarioEmpresa[]>({url: `/api/usuarios-empresa/empresa/${id_empresa}/tecnicos/`, method: 'get'})
            return response.data
        } catch(error: any) {
...
export const listaComprasOrdenTrabajoThunk = createAsyncThunk<IDetalleOrdenDeTrabajoCompra[], {id_orden: string | number | undefined}, {rejectValue: string}>(
    'ordenTrabajo/listaComprasOrdenTrabajoThunk',
    async ({id_orden}, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<IDetalleOrdenDeTrabajoCompra[]>({url: `/api/ordenes-trabajo/${id_orden}/detalles-trabajo/lista-compras/`, method: 'get'})
            return response.data
        } catch(error: any) {
...
export const listaOrdenTrabajoThunk = createAsyncThunk<IOrdenDeTrabajo[], undefined, {rejectValue: string}>(
    'ordenTrabajo/listaOrdenTrabajoThunk',
    async (_, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<IOrdenDeTrabajo[]>({url: `/api/ordenes-trabajo/`, method: 'get'})
            return response.data
        } catch(error: any) {
...
export const detalleOrdenTrabajoThunk = createAsyncThunk<IOrdenDeTrabajo, {id_ordenTrabajo: number | string | any}, {rejectValue: string}>(
    'ordenTrabajo/detalleOrdenTrabajoThunk',
    async ({id_ordenTrabajo}, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<IOrdenDeTrabajo>({url: `/api/ordenes-trabajo/${id_ordenTrabajo}/`, method: 'get'})
            return response.data
        } catch(error: any) {
            return rejectWithValue(error.response.data)
        }
...
export const listaSeguimientosThunk = createAsyncThunk<ISeguimientoOrden[], {id_orden: number | string | undefined, id_detalle: number | string | undefined}, {rejectValue: string}>(
    'ordenTrabajo/listaSeguimientosThunk',
    async ({id_orden, id_detalle}, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<ISeguimientoOrden[]>({ 
                url: `/api/ordenes-trabajo/${id_orden}/detalles-trabajo/${id_detalle}/seguimientos/`, 
                method: 'get' 
            });
            return response.data;
        } catch (error: any) {
...
export const detalleSeguimientoThunk = createAsyncThunk<ISeguimientoOrden, { ordenId: number | string | undefined, idDetalle: number | string | any }, { rejectValue: string }>(
    'ordenTrabajo/detalleSeguimientoThunk',
    async ({ordenId, idDetalle}, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<ISeguimientoOrden>({ url: `/api/ordenes-trabajo/${ordenId}/seguimientos/${idDetalle}/`, method: 'get' });
            return response.data;
        } catch (error: any) {
            return rejectWithValue(error.response.data || "Error al obtener el detalle del seguimiento");
        }
    }
);

export const listaAdjuntosThunk = createAsyncThunk<IAdjuntoDeOrden[], {ordenId:number | undefined}, { rejectValue: string }>(
    'ordenTrabajo/listaAdjuntosThunk',
    async ({ordenId}, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<IAdjuntoDeOrden[]>({ url: `/api/ordenes-trabajo/${ordenId}/adjuntos/`, method: 'get' });
            return response.data;
        } catch (error: any) {
            return rejectWithValue(error.response.data);
        }
...
export const detalleAdjuntoThunk = createAsyncThunk<IAdjuntoDeOrden, {id_adjunto: number | string | undefined, id_orden: string | number | undefined}, {rejectValue: string}>(
    'ordenTrabajo/detalleAdjuntoThunk',
    async ({id_adjunto, id_orden}, { rejectWithValue }) => {
        try {
            const response = await ApiService.fetchData<IAdjuntoDeOrden>({url: `/api/ordenes-trabajo/${id_orden}/adjuntos/${id_adjunto}/`, method: 'get'});
            return response.data;
        } catch (error: any) {
            return rejectWithValue(error.response.data);
        }
...
export const listaHistorialCambiosThunk = createAsyncThunk<IHistorialCambiosOrden[], {id_orden: string | number | undefined}, { rejectValue: string }>(
    'ordenTrabajo/listaHistorialCambiosThunk',
    async ({id_orden}, { rejectWithValue }) => {
        try {
            const response = await ApiService.fetchData<IHistorialCambiosOrden[]>({url: `/api/ordenes-trabajo/${id_orden}/historial-cambios-orden/`, method: 'get'});
            return response.data;
        } catch (error: any) {
            return rejectWithValue(error.response.data || "Error al obtener el historial de cambios de la orden");
        }
    }
);

export const detalleHistorialCambioThunk = createAsyncThunk<IHistorialCambiosOrden, {id_orden: string | number | undefined, id_historial: number | string | undefined }, { rejectValue: string }>(
    'ordenTrabajo/detalleHistorialCambioThunk',
    async ({ id_orden, id_historial }, { rejectWithValue }) => {
        try {
            const response = await ApiService.fetchData<IHistorialCambiosOrden>({ url: `/api/ordenes-trabajo/${id_orden}/historial-cambios-orden/${id_historial}/`, method: 'get' });
            return response.data;
        } catch (error: any) {
            return rejectWithValue(error.response.data);
        }
...
export const listaDetalleTrabajoOTThunk = createAsyncThunk<IDetalleOrdenDeTrabajo[], {id_orden: string | number | undefined}, {rejectValue: string}>(
    'ordenTrabajo/listaDetalleTrabajoOTThunk',
    async ({id_orden}, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<IDetalleOrdenDeTrabajo[]>({url: `/api/ordenes-trabajo/${id_orden}/detalles-trabajo`, method: 'get'})
            return response.data
        } catch (error: any) {
...
export const listaTrabajosFiltradasThunk = createAsyncThunk<IListaTrabajosFiltrado, {id_orden: number | string | undefined}, {rejectValue: string}>(
    'ordenTrabajo/listaTrabajosFiltradasThunk',
    async ({id_orden}, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<IListaTrabajosFiltrado>({url: `/api/ordenes-trabajo/${id_orden}/detalles-trabajo/trabajos-disponibles/`, method: 'get'})
            return response.data
        } catch (error: any) {
            return rejectWithValue(error.response.data || "Error al obtener la lista de cotizaciones filtrada")
        }
    }
)

export const detalleDelDetalleTrabajoThunk = createAsyncThunk<IDetalleOrdenDeTrabajo, {id_orden: number | string | undefined, id_detalle: string | number | undefined}, {rejectValue: string}>(
    'ordenTrabajo/detalleDelDetalleTrabajoThunk',
    async ({id_detalle, id_orden}, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<IDetalleOrdenDeTrabajo>({url: `/api/ordenes-trabajo/${id_orden}/detalles-trabajo/${id_detalle}/`, method: 'get'})
            return response.data
        } catch (error: any) {
            return rejectWithValue(error.response.data || "Error al obtener el detalle del detalle del trabajo")
        }
    }
)

export const listarSimpleHistorialThunk = createAsyncThunk<IHistorialSimple[], {id: number | undefined}, { rejectValue: string }>(
  'ordenTrabajo/listarSimpleHistorialThunk',
    async ({ id }, { rejectWithValue }) => {
        try {
            const response = await ApiService.fetchData<IHistorialSimple[]>({
                url: `/api/ordenes-trabajo/${id}/history/`,
                method: 'get'
            });
            return response.data;
        } catch (error: any) {
...
export const listaInsumosThunk = createAsyncThunk<IInsumo[], {id_orden_trabajo: number}, {rejectValue: string}>(
    'ordenTrabajo/listaInsumosThunk',
    async ({id_orden_trabajo}, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<IInsumo[]>({url: `/api/ordenes-trabajo/${id_orden_trabajo}/insumos/`, method: 'get'});
            return response.data;
        } catch (error: any) {
...
export const listaDetalleTrabajoSinInsumoThunk = createAsyncThunk<IDetalleOrdenDeTrabajo[], {id_orden: string | number | undefined}, {rejectValue: string}>(
    'ordenTrabajo/listaDetalleTrabajoSinInsumoThunk',
    async ({id_orden}, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<IDetalleOrdenDeTrabajo[]>({url: `/api/ordenes-trabajo/${id_orden}/detalles-trabajo/detalles-sin-insumo/`, method: 'get'});
            return response.data;
        } catch (error: any) {
            return rejectWithValue(error.response.data || "Error al obtener la lista de detalles de trabajo sin insumo");
        }
    }
);

export const detalleConVisitaThunk = createAsyncThunk<IVisitaEnOT, {ordenId: number | string | undefined, detalleTrabajoId: number | string | undefined | null}, {rejectValue: string}>(
    ...
    async ({ ordenId, detalleTrabajoId }, { rejectWithValue }) => {
        try {
            ...
            return rejectWithValue(error.response?.data || "Error al obtener los detalles con visitas");
        }
    }
);

export const listaDetallesSeguimientosOTThunk = createAsyncThunk<IListaDetallesSeguimientosOT, {id_orden: number | string | undefined}, {rejectValue: string}>(
    'ordenTrabajo/listaDetallesSeguimientosOTThunk',
    async ({id_orden}, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<IListaDetallesSeguimientosOT>({url: `/api/ordenes-trabajo/${id_orden}/detalles-seguimientos-visitas/`, method: 'get'})
            return response.data
        } catch (error: any) {
