...
export const detalleCotizacionPorNumeroThunk = createAsyncThunk<ICotizacion, {numero_cotizacion: string | number | undefined}, {rejectValue: string}>(
    'cotizacion/detalleCotizacionPorNumeroThunk',
    async ({numero_cotizacion}, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<ICotizacion>({url: `/api/cotizaciones/por-numero/${numero_cotizacion}/`, method: 'get'})
...
export const listaCotizacionesThunk = createAsyncThunk<ICotizacion[], undefined, { rejectValue: string }>(
    'cotizacion/listaCotizacionesThunk',
    async (_, { rejectWithValue }) => {
        try {
            const response = await ApiService.fetchData<ICotizacion[]>({url: '/api/cotizaciones/', method: 'get' })
            return response.data
        } catch (error: any) {
            return rejectWithValue(error.response.data)
        }
...
export const detalleCotizacionThunk = createAsyncThunk<ICotizacion, { id_cotizacion: number | string | undefined }, { rejectValue: string }>(
    'cotizacion/detalleCotizacionThunk',
    async ({ id_cotizacion }, { rejectWithValue }) => {
        try {
            const response = await ApiService.fetchData<ICotizacion>({url: `/api/cotizaciones/${id_cotizacion}/`, method: 'get' })
            return response.data
        } catch (error: any) {
            return rejectWithValue(error.response.data)
        }
...
export const listaItemsCotizacionThunk = createAsyncThunk<IItemCotizacion[], undefined, { rejectValue: string }>(
    'cotizacion/listaItemsCotizacionThunk',
    async (_, { rejectWithValue }) => {
        try {
            const response = await ApiService.fetchData<IItemCotizacion[]>({url: `/api/items-cotizacion/`, method: 'get' })
            return response.data
        } catch (error: any) {
            return rejectWithValue(error.response.data)
        }
...
export const detalleItemCotizacionThunk = createAsyncThunk<IItemCotizacion, { id_item: number | string | undefined }, { rejectValue: string }>(
    'cotizacion/detalleItemCotizacionThunk',
    async ({ id_item }, { rejectWithValue }) => {
        try {
            const response = await ApiService.fetchData<IItemCotizacion>({url: `/api/items-cotizacion/${id_item}/`, method: 'get' })
            return response.data
        } catch (error: any) {
            return rejectWithValue(error.response.data)
        }
...
export const listaItemsEnCotizacionThunk = createAsyncThunk<IItemCotizacion[], { id_cotizacion: number | string | undefined}, { rejectValue: string }>(
    'cotizacion/listaItemsEnCotizacionThunk',
    async ({ id_cotizacion }, { rejectWithValue }) => {
        try {
            const response = await ApiService.fetchData<IItemCotizacion[]>({url: `/api/cotizaciones/${id_cotizacion}/items/`, method: 'get'})
            return response.data
        } catch (error: any) {
            return rejectWithValue(error.response.data)
        }
...
export const detalleItemEnCotizacionThunk = createAsyncThunk<IItemCotizacion, { id_cotizacion: number | string | undefined, id_item: number | string | undefined }, { rejectValue: string }>(
    'cotizacion/detalleItemEnCotizacionThunk',
    async ({ id_cotizacion, id_item }, { rejectWithValue }) => {
        try {
            const response = await ApiService.fetchData<IItemCotizacion>({url: `/api/cotizaciones/${id_cotizacion}/items/${id_item}/`, method: 'get' })
            return response.data
        } catch (error: any) {
            return rejectWithValue(error.response.data)
        }
...
export const seguimientoCotizacionThunk = createAsyncThunk<ISeguimientoCotizacion[], { id_cotizacion: number | string | undefined }, { rejectValue: string }>(
    'cotizacion/seguimientoCotizacionThunk',
    async ({ id_cotizacion }, { rejectWithValue }) => {
        try {
            const response = await ApiService.fetchData<ISeguimientoCotizacion[]>({url: `/api/cotizaciones/${id_cotizacion}/seguimientos/`, method: 'get' })
            return response.data
        } catch (error: any) {
            return rejectWithValue(error.response.data)
        }
...
export const detalleSeguimientoCotizacionThunk = createAsyncThunk<ISeguimientoCotizacion, { id_cotizacion: number | string | undefined, id_seguimiento: number | string | undefined }, { rejectValue: string }>(
    'cotizacion/detalleSeguimientoCotizacionThunk',
    async ({ id_cotizacion, id_seguimiento }, { rejectWithValue }) => {
        try {
            const response = await ApiService.fetchData<ISeguimientoCotizacion>({url: `/api/cotizaciones/${id_cotizacion}/seguimientos/${id_seguimiento}/`, method: 'get' })
            return response.data
        } catch (error: any) {
            return rejectWithValue(error.response.data)
        }
...
export const listaUsuariosParaSolicitanteThunk = createAsyncThunk<IUsuarioEmpresa[], {id_cotizacion: string | number | undefined}, {rejectValue: string}>(
    'cotizacion/listaUsuariosParaSolicitanteThunk',
    async ({id_cotizacion}, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<IUsuarioEmpresa[]>({url: `/api/cotizaciones/${id_cotizacion}/solicitantes-cotizacion/sin-relacionar/`, method: 'get'})
            return response.data
        } catch (error: any) {
            return rejectWithValue(error.response.data || "Error al obtener la lista de solicitantes")
        }
...
export const listaOrdenesDeCompraCotizacionThunk = createAsyncThunk<IOrdenCompra[], {id_cotizacion: number | string | undefined}, {rejectValue: string}>(
    ...
    async ({id_cotizacion}, {rejectWithValue}) => {
        try {
            const response = await ApiService.fetchData<IOrdenCompra[]>({url: `/api/cotizaciones/${id_cotizacion}/ordenes-compras/`, method: 'get'})
            return response.data
        } catch (error: any) {
            return rejectWithValue(error.response.data || "Error al obtener la lista de ordenes asociadas a cotización")
        }
    }
)
