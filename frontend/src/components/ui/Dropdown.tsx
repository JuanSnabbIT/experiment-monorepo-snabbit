...
const Dropdown: FC<IDropdownProps> = (props) => {
	const { children, className, isOpen = null, setIsOpen, tag: Tag = 'div', footer } = props;
...
export const DropdownFooter: FC<IDropdownFooterProps> = ({ children, className }) => {
	return (
		<div
			className={classNames(
				'border-t border-zinc-300/25 dark:border-zinc-800/50 h-full',
				className
			)}
			style={{ position: 'sticky', bottom: 0, zIndex: 9999, background: 'inherit', marginBottom: 0, paddingBottom: 0 }}
		>
			{children}
		</div>
	);
