...
|---|--------|-----------------------|--------|
| 1 | Empresas | [EXPLORACION_EMPRESAS.md](./exploracion/empresas.md) | ✅ Completo |
...
2. **Implementar validaciones backend**
   ...
   - Ver: `.github/instrucciones/backend-instructions.md` (sección 5)
...
- **Backend**: `.github/instrucciones/backend-instructions.md`
- **Frontend**: `.github/instrucciones/frontend-instructions.md`
- **Seguridad**: `.github/instrucciones/security.md`
