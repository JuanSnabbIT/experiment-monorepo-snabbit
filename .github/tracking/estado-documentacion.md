...
**Creadas**:
- `.github/instrucciones/backend/` ✅
- `.github/instrucciones/frontend/` ✅
...
**Archivos creados** (5 documentos en `.github/instrucciones/backend/`):
...
**Archivos que permanecen en `.github/instrucciones/` (generales/sistema completo)**:
- `redux-thunks.md` ✅
- `store-structure.md` ✅
- `standards.md` ✅
- `security.md` ✅
...
**Ubicación sugerida**: `.github/INDICE_MAESTRO.md`
