...
Ver [security.md](./procesos/security.md) para detalles sobre rotación de claves y auditoría.
...
- [Frontend (React)](./frontend/general.md): integración con APIs.
- [Seguridad](./procesos/security.md): JWT, CORS/CSRF, validaciones.
- [Testing](./testing.md): estrategias de tests backend.
- [Performance](./performance.md): optimización de queries (N+1, índices).
- [Observabilidad](./procesos/observability.md): logging, métricas, health checks.
