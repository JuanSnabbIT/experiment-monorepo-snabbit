...
- [Backend (Django)](./backend/general.md): consumo de APIs REST.
...
- [Seguridad](./procesos/security.md): manejo de tokens JWT, validaciones frontend.
...
- [Estándares](./procesos/standards.md): convenciones de código, ESLint, Prettier.
