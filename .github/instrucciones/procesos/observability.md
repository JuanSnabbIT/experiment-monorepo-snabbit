...
- [Backend (Django)](./backend/general.md): logging, métricas, health checks.
- [Frontend (React)](./frontend/general.md): Web Vitals, captura de errores.
- [Performance](./performance.md): métricas de latencia y throughput.
- [CI/CD](./procesos/ci-cd.md): validación de health checks post-deploy.
- [Playbooks](./soporte/playbooks.md): uso de logs y métricas en troubleshooting.
