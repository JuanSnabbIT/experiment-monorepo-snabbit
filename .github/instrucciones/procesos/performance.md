...
- **Alertas**: configurar umbrales en [observability.md](./procesos/observability.md).
...
- [Backend (Django)](./backend/general.md): optimización de queries, Celery.
- [Frontend (React)](./frontend/general.md): memoización, lazy loading.
- [Observabilidad](./procesos/observability.md): métricas de performance, alertas.
