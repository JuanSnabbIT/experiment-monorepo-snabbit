...
- [Backend (Django)](./backend/general.md): autenticación JWT, permisos, validaciones.
- [Frontend (React)](./frontend/general.md): manejo de tokens, rutas privadas.
- [Observabilidad](./procesos/observability.md): logging seguro, métricas de accesos.
- [PR Flow](./procesos/pr-flow.md): revisión de seguridad en PRs.
