...
- Ver [ci-cd.md](./procesos/ci-cd.md) para configuración de pipelines.
...
- [Backend (Django)](./backend/general.md): tests de modelos, serializers, vistas.
- [Frontend (React)](./frontend/general.md): tests de componentes, hooks, servicios.
- [CI/CD](./procesos/ci-cd.md): ejecutar tests en pipelines, reportar cobertura.
- [Estándares](./procesos/standards.md): convenciones de tests y archivos.
