...
- [backend-instructions.md](./backend-instructions.md), [frontend-instructions.md](./frontend-instructions.md): guías técnicas.
- [pr-flow.md](./pr-flow.md): proceso de contribución.
...
- [CI/CD](./ci-cd.md): rollback automatizado, pipelines.
- [Observabilidad](./observability.md): uso de logs y métricas en troubleshooting.
- [Seguridad](./security.md): manejo de secretos, rotación tras incidentes.
- [Backend (Django)](./backend-instructions.md), [Frontend (React)](./frontend-instructions.md): guías técnicas.
