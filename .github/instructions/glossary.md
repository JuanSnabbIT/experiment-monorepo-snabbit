...
- [Backend (Django)](./backend-instructions.md): conceptos técnicos de Django/DRF.
- [Frontend (React)](./frontend-instructions.md): conceptos técnicos de React/Redux.
- [Seguridad](./security.md): JWT, CORS, CSRF.
