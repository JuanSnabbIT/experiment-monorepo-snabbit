...
| Archivo | Descripción |
|---------|-------------|
| `.github/instructions/backend-instructions.md` | Guía de backend (sección 5: Autenticación) |
| `.github/instructions/security.md` | Seguridad y JWT |
| `.github/instructions/frontend-instructions.md` | Guía de frontend |
...
- [Backend (Django)](./backend-instructions.md): configuración de autenticación y permisos (sección 5)
- [Frontend (React)](./frontend-instructions.md): componentes de autorización y rutas protegidas
- [Seguridad](./security.md): JWT, CORS/CSRF, validaciones, rotación de claves
- [Estándares](./standards.md): convenciones de código y estructura
- [Playbooks](./playbooks.md): procedimientos de onboarding y troubleshooting
