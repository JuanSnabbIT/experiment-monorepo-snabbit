...
- [Backend (Django)](./backend-instructions.md): PEP 8, tipado, docstrings.
- [Frontend (React)](./frontend-instructions.md): ESLint, Prettier, tipado TypeScript.
- [PR Flow](./pr-flow.md): revisión de código y checklist de estándares.
