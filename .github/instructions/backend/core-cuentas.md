...
- [ARQUITECTURA_SISTEMA.md](../../ARQUITECTURA_SISTEMA.md): Visión general del monorepo
- [empresas.md](./empresas.md): Modelo UsuarioEmpresa, SucursalEmpresa (próximo documento)
- [instructions/backend-instructions.md](../backend-instructions.md): Guía general de backend
- [instructions/security.md](../security.md): JWT, rotación de tokens, validaciones
- [INICIALIZACION.md](../../INICIALIZACION.md): setup_superuser.py, flujos de creación de usuario
