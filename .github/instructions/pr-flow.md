...
- [ ] Código sigue estándares del repo ([standards.md](./standards.md)).
...
- [Estándares](./standards.md): convenciones de código y formato.
- [Testing](./testing.md): estrategias de tests y cobertura.
- [Seguridad](./security.md): revisión de seguridad en PRs.
- [CI/CD](./ci-cd.md): pipelines automáticos y validaciones.
