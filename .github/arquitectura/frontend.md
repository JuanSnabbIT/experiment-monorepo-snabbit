...
- **[ARQUITECTURA_SISTEMA.md](./arquitectura/sistema.md)**: Visión general del monorepo completo
- **[CONFIGURACION_DESARROLLO.md](./guias/desarrollo.md)**: Setup de VS Code y workflows
- **[instructions/frontend-instructions.md](./instrucciones/frontend-instructions.md)**: Guía de desarrollo frontend
- **[instructions/redux-thunks.md](./instrucciones/redux-thunks.md)**: Detalles sobre Redux y thunks
- **[instructions/store-structure.md](./instrucciones/store-structure.md)**: Índice de slices completo
