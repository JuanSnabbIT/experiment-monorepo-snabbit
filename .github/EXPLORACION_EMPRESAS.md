...
- [Inicialización del Sistema](../INICIALIZACION.md): Scripts de setup
- [Backend Instructions](./instructions/backend-instructions.md): ViewSets, filtros
- [Frontend Instructions](./instructions/frontend-instructions.md): Componentes, formularios
- [Redux Toolkit y Thunks](./instructions/redux-thunks.md): Thunks asíncronos
- [Store Structure](./instructions/store-structure.md): Índice de slices
