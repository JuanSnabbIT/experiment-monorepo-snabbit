...
- [Inicialización del Sistema](./INICIALIZACION.md) - Guía completa de setup con scripts
- [Exploración: Empresas](./EXPLORACION_EMPRESAS.md) - Bugs encontrados, lecciones aprendidas

### Instrucciones Técnicas
- [Backend Instructions](./instructions/backend-instructions.md) - Modelos, ViewSets, permisos
- [Frontend Instructions](./instructions/frontend-instructions.md) - Componentes, Redux, servicios
- [Security](./instructions/security.md) - JWT, CORS, validaciones
- [Playbooks](./instructions/playbooks.md) - Troubleshooting operativo

### Backend Detallado
- [Core + Cuentas](./instructions/backend/core-cuentas.md) - Autenticación, personalización
- [Empresas + Cotizaciones](./instructions/backend/empresas-cotizaciones.md) - Gestión de empresas
- [Contratos + Bodegas + Items](./instructions/backend/contratos-bodegas-items.md) - Operaciones
- [OT + Recursos + Rendiciones + Visitas](./instructions/backend/ordentrabajo-recursos-rendiciones-visitas.md) - Operaciones de campo
- [Vacaciones + Calendario + Activos + Retroalimentación](./instructions/backend/vacaciones-calendario-activos-retroalimentacion.md) - Soporte
...
4. **Actualizar este documento** (`SCRIPTS_UTILIDADES.md`):
