...
ETIQUETAS_PREDEFINIDAS = [
    ...
    {"clave": "cotizaciones_tabla", "nombre_display": "Tabla de Cotizaciones Vinculadas", "categoria": "economico", "origen_dato": None},
    {"clave": "cantidad_cotizaciones", "nombre_display": "Cantidad de Cotizaciones Vinculadas", "categoria": "economico", "origen_dato": None},
    {"clave": "total_cotizaciones", "nombre_display": "Total Consolidado de Cotizaciones", "categoria": "economico", "origen_dato": None},
    {"clave": "forma_pago_venta", "nombre_display": "Forma de Pago Venta", "categoria": "economico", "origen_dato": None},
    {"clave": "cantidad_cuotas_venta", "nombre_display": "Cantidad de Cuotas Venta", "categoria": "economico", "origen_dato": None},
    {"clave": "cuotas_venta_tabla", "nombre_display": "Tabla de Cuotas Venta", "categoria": "economico", "origen_dato": None},
    {"clave": "cotizaciones_totales_convertidos", "nombre_display": "Totales Convertidos de Cotizaciones", "categoria": "economico", "origen_dato": None},
    {"clave": "dolar_observado_cotizaciones", "nombre_display": "Dolar Observado por Cotizacion", "categoria": "economico", "origen_dato": None},
    # servicio
