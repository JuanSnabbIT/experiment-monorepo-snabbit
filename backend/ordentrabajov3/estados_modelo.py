...
ESTADO_PARCIALMENTE_FACTURADA = "parcialmente_facturada"
...
ESTADOS_OT_V3 = [
    ...
    (ESTADO_COMPLETADA, "Completada"),
    (ESTADO_FACTURADA, "Facturada"),
    (ESTADO_PARCIALMENTE_FACTURADA, "Parcialmente Facturada"),
    (ESTADO_CERRADA, "Cerrada"),
    (ESTADO_CANCELADA, "Cancelada"),
]
...
TRANSICIONES_VALIDAS_V3 = {
    ...
    ESTADO_RETROALIMENTACION: [ESTADO_POR_FACTURAR, ESTADO_CANCELADA],
    ...
    ESTADO_PARCIALMENTE_FACTURADA: [ESTADO_FACTURADA, ESTADO_CANCELADA],
...
ETAPA_UI_MAP = {
    ...
    ESTADO_PARCIALMENTE_FACTURADA: "por_facturar",
